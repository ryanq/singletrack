...
export const DigitalAudio: MessageFns<DigitalAudio> = {
  encode(_: DigitalAudio, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio {
...
export const DigitalAudio_Setup: MessageFns<DigitalAudio_Setup> = {
  encode(message: DigitalAudio_Setup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.buses) {
      DigitalAudio_Bus.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.monitorDevice !== undefined) {
      DigitalAudio_Device.encode(message.monitorDevice, writer.uint32(18).fork()).join();
    }
    if (message.mainOutputDevice !== undefined) {
      DigitalAudio_Device.encode(message.mainOutputDevice, writer.uint32(26).fork()).join();
    }
    if (message.enableSdiNdiDevice !== false) {
      writer.uint32(32).bool(message.enableSdiNdiDevice);
    }
    if (message.sdiNdiDevice !== undefined) {
      DigitalAudio_Device.encode(message.sdiNdiDevice, writer.uint32(42).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio_Setup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DigitalAudio_Setup {
    return {
      buses: globalThis.Array.isArray(object?.buses) ? object.buses.map((e: any) => DigitalAudio_Bus.fromJSON(e)) : [],
      ...
      mainOutputDevice: isSet(object.mainOutputDevice)
        ...
        : undefined,
      enableSdiNdiDevice: isSet(object.enableSdiNdiDevice) ? globalThis.Boolean(object.enableSdiNdiDevice) : false,
      sdiNdiDevice: isSet(object.sdiNdiDevice) ? DigitalAudio_Device.fromJSON(object.sdiNdiDevice) : undefined,
      monitorOnMains: isSet(object.monitorOnMains) ? globalThis.Boolean(object.monitorOnMains) : false,
  ...
  toJSON(message: DigitalAudio_Setup): unknown {
    ...
    if (message.mainOutputDevice !== undefined) {
      obj.mainOutputDevice = DigitalAudio_Device.toJSON(message.mainOutputDevice);
    }
    if (message.enableSdiNdiDevice !== false) {
...
export const DigitalAudio_Bus: MessageFns<DigitalAudio_Bus> = {
  encode(message: DigitalAudio_Bus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio_Bus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DigitalAudio_Bus {
    return {
      ...
      testTone: isSet(object.testTone) ? globalThis.Boolean(object.testTone) : false,
      masterLevel: isSet(object.masterLevel) ? globalThis.Number(object.masterLevel) : 0,
    };
  },
...
export const DigitalAudio_Device: MessageFns<DigitalAudio_Device> = {
  encode(message: DigitalAudio_Device, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.renderID !== "") {
    ...
    for (const v of message.formats) {
      DigitalAudio_Device_Format.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.routing !== undefined) {
      DigitalAudio_Device_Routing.encode(message.routing, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio_Device {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DigitalAudio_Device {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      renderID: isSet(object.renderID) ? globalThis.String(object.renderID) : "",
  ...
  toJSON(message: DigitalAudio_Device): unknown {
    ...
    if (message.formats?.length) {
      obj.formats = message.formats.map((e) => DigitalAudio_Device_Format.toJSON(e));
    }
    if (message.routing !== undefined) {
...
export const DigitalAudio_Device_Format: MessageFns<DigitalAudio_Device_Format> = {
  encode(message: DigitalAudio_Device_Format, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio_Device_Format {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DigitalAudio_Device_Map: MessageFns<DigitalAudio_Device_Map> = {
  encode(message: DigitalAudio_Device_Map, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio_Device_Map {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DigitalAudio_Device_Map {
    return {
      channelIndex: isSet(object.channelIndex) ? globalThis.Number(object.channelIndex) : 0,
...
export const DigitalAudio_Device_Channel: MessageFns<DigitalAudio_Device_Channel> = {
  encode(message: DigitalAudio_Device_Channel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio_Device_Channel {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DigitalAudio_Device_Channel {
    return {
      muteEnable: isSet(object.muteEnable) ? globalThis.Boolean(object.muteEnable) : false,
      soloEnable: isSet(object.soloEnable) ? globalThis.Boolean(object.soloEnable) : false,
      toneEnable: isSet(object.toneEnable) ? globalThis.Boolean(object.toneEnable) : false,
      audioDelay: isSet(object.audioDelay) ? globalThis.Number(object.audioDelay) : 0,
...
export const DigitalAudio_Device_Routing: MessageFns<DigitalAudio_Device_Routing> = {
  encode(message: DigitalAudio_Device_Routing, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.channels) {
      DigitalAudio_Device_Channel.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.map) {
      DigitalAudio_Device_Map.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.isCustomMap !== false) {
      writer.uint32(24).bool(message.isCustomMap);
    }
    if (message.masterChannel !== undefined) {
      DigitalAudio_Device_Channel.encode(message.masterChannel, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DigitalAudio_Device_Routing {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DigitalAudio_Device_Routing {
    return {
      channels: globalThis.Array.isArray(object?.channels)
        ...
        : [],
      map: globalThis.Array.isArray(object?.map) ? object.map.map((e: any) => DigitalAudio_Device_Map.fromJSON(e)) : [],
      isCustomMap: isSet(object.isCustomMap) ? globalThis.Boolean(object.isCustomMap) : false,
  ...
  toJSON(message: DigitalAudio_Device_Routing): unknown {
    ...
    if (message.channels?.length) {
      obj.channels = message.channels.map((e) => DigitalAudio_Device_Channel.toJSON(e));
    }
    ...
    if (message.masterChannel !== undefined) {
      obj.masterChannel = DigitalAudio_Device_Channel.toJSON(message.masterChannel);
    }
    return obj;
  },
