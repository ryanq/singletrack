...
export const MusicKeyScale: MessageFns<MusicKeyScale> = {
  encode(message: MusicKeyScale, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MusicKeyScale {
