...
export const Effect: MessageFns<Effect> = {
  encode(message: Effect, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.variables) {
      Effect_EffectVariable.encode(v!, writer.uint32(58).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Effect {
    return {
      ...
      behaviorDescription: isSet(object.behaviorDescription) ? globalThis.String(object.behaviorDescription) : "",
  ...
  toJSON(message: Effect): unknown {
    ...
    if (message.variables?.length) {
      obj.variables = message.variables.map((e) => Effect_EffectVariable.toJSON(e));
    }
    return obj;
  },
...
export const Effect_EffectVariable: MessageFns<Effect_EffectVariable> = {
  encode(message: Effect_EffectVariable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    if (message.int !== undefined) {
      Effect_EffectVariable_EffectInt.encode(message.int, writer.uint32(26).fork()).join();
    }
    if (message.float !== undefined) {
      Effect_EffectVariable_EffectFloat.encode(message.float, writer.uint32(34).fork()).join();
    }
    if (message.color !== undefined) {
      Effect_EffectVariable_EffectColor.encode(message.color, writer.uint32(42).fork()).join();
    }
    if (message.direction !== undefined) {
      Effect_EffectVariable_EffectDirection.encode(message.direction, writer.uint32(50).fork()).join();
    }
    if (message.double !== undefined) {
      Effect_EffectVariable_EffectDouble.encode(message.double, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Effect_EffectVariable {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Effect_EffectVariable): unknown {
    ...
    if (message.direction !== undefined) {
      obj.direction = Effect_EffectVariable_EffectDirection.toJSON(message.direction);
    }
    if (message.double !== undefined) {
...
export const Effect_EffectVariable_EffectInt: MessageFns<Effect_EffectVariable_EffectInt> = {
  encode(message: Effect_EffectVariable_EffectInt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Effect_EffectVariable_EffectInt {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Effect_EffectVariable_EffectFloat: MessageFns<Effect_EffectVariable_EffectFloat> = {
  encode(message: Effect_EffectVariable_EffectFloat, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Effect_EffectVariable_EffectFloat {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Effect_EffectVariable_EffectDouble: MessageFns<Effect_EffectVariable_EffectDouble> = {
  encode(message: Effect_EffectVariable_EffectDouble, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Effect_EffectVariable_EffectDouble {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Effect_EffectVariable_EffectColor: MessageFns<Effect_EffectVariable_EffectColor> = {
  encode(message: Effect_EffectVariable_EffectColor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.color !== undefined) {
      Color.encode(message.color, writer.uint32(10).fork()).join();
    }
    if (message.defaultColor !== undefined) {
      Color.encode(message.defaultColor, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Effect_EffectVariable_EffectColor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Effect_EffectVariable_EffectDirection: MessageFns<Effect_EffectVariable_EffectDirection> = {
  encode(message: Effect_EffectVariable_EffectDirection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Effect_EffectVariable_EffectDirection {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Effect_EffectVariable_EffectDirection {
    return {
      ...
      defaultDirection: isSet(object.defaultDirection)
        ...
        : 0,
      availableDirections: isSet(object.availableDirections) ? globalThis.Number(object.availableDirections) : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Effect_EffectVariable_EffectDirection>, I>>(
    ...
    return Effect_EffectVariable_EffectDirection.fromPartial(base ?? ({} as any));
  },
...
export const Effect_Preset: MessageFns<Effect_Preset> = {
  encode(message: Effect_Preset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.name !== "") {
    ...
    for (const v of message.effects) {
      Effect.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Effect_Preset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Transition: MessageFns<Transition> = {
  encode(message: Transition, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.duration !== 0) {
      writer.uint32(9).double(message.duration);
    }
    if (message.favoriteUuid !== undefined) {
      UUID.encode(message.favoriteUuid, writer.uint32(18).fork()).join();
    }
    if (message.effect !== undefined) {
      Effect.encode(message.effect, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Transition {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Transition_Preset: MessageFns<Transition_Preset> = {
  encode(message: Transition_Preset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Transition_Preset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
