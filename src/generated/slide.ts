...
export interface Slide_Element_DataLink {
  ...
  playbackMarkerColor?: Slide_Element_DataLink_PlaybackMarkerIdentifier | undefined;
...
export function slide_Element_DataLink_SlideSourceTypeFromJSON(object: any): Slide_Element_DataLink_SlideSourceType {
  switch (object) {
    case 0:
...
export function slide_Element_DataLink_SlideSourceTypeToJSON(object: Slide_Element_DataLink_SlideSourceType): string {
  switch (object) {
...
export function slide_Element_DataLink_GroupSourceTypeFromJSON(object: any): Slide_Element_DataLink_GroupSourceType {
  switch (object) {
    case 0:
...
export function slide_Element_DataLink_GroupSourceTypeToJSON(object: Slide_Element_DataLink_GroupSourceType): string {
  switch (object) {
...
export function slide_Element_DataLink_SlideLabelSourceFromJSON(object: any): Slide_Element_DataLink_SlideLabelSource {
  switch (object) {
    case 0:
...
export function slide_Element_DataLink_SlideLabelSourceToJSON(object: Slide_Element_DataLink_SlideLabelSource): string {
  switch (object) {
...
export const Slide: MessageFns<Slide> = {
  encode(message: Slide, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.elements) {
      Slide_Element.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.elementBuildOrder) {
      UUID.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.guidelines) {
      AlignmentGuide.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.drawsBackgroundColor !== false) {
      writer.uint32(32).bool(message.drawsBackgroundColor);
    }
    if (message.backgroundColor !== undefined) {
      Color.encode(message.backgroundColor, writer.uint32(42).fork()).join();
    }
    if (message.size !== undefined) {
      Graphics_Size.encode(message.size, writer.uint32(50).fork()).join();
    }
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide {
  ...
  toJSON(message: Slide): unknown {
    ...
    if (message.elementBuildOrder?.length) {
      obj.elementBuildOrder = message.elementBuildOrder.map((e) => UUID.toJSON(e));
    }
...
export const Slide_Element: MessageFns<Slide_Element> = {
  encode(message: Slide_Element, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.element !== undefined) {
      Graphics_Element.encode(message.element, writer.uint32(10).fork()).join();
    }
    if (message.buildIn !== undefined) {
      Slide_Element_Build.encode(message.buildIn, writer.uint32(18).fork()).join();
    }
    if (message.buildOut !== undefined) {
      Slide_Element_Build.encode(message.buildOut, writer.uint32(26).fork()).join();
    }
    if (message.info !== 0) {
    ...
    for (const v of message.dataLinks) {
      Slide_Element_DataLink.encode(v!, writer.uint32(50).fork()).join();
    }
    for (const v of message.childBuilds) {
      Slide_Element_ChildBuild.encode(v!, writer.uint32(58).fork()).join();
    }
    if (message.revealFromIndex !== 0) {
      writer.uint32(64).uint32(message.revealFromIndex);
    }
    if (message.textScroller !== undefined) {
      Slide_Element_TextScroller.encode(message.textScroller, writer.uint32(74).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element {
    return {
      ...
      childBuilds: globalThis.Array.isArray(object?.childBuilds)
        ...
        : [],
      revealFromIndex: isSet(object.revealFromIndex) ? globalThis.Number(object.revealFromIndex) : 0,
  ...
  toJSON(message: Slide_Element): unknown {
    ...
    if (message.dataLinks?.length) {
      obj.dataLinks = message.dataLinks.map((e) => Slide_Element_DataLink.toJSON(e));
    }
    if (message.childBuilds?.length) {
      obj.childBuilds = message.childBuilds.map((e) => Slide_Element_ChildBuild.toJSON(e));
    }
    if (message.revealFromIndex !== 0) {
      obj.revealFromIndex = Math.round(message.revealFromIndex);
    }
    if (message.textScroller !== undefined) {
      obj.textScroller = Slide_Element_TextScroller.toJSON(message.textScroller);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element>, I>>(base?: I): Slide_Element {
...
export const Slide_Element_Build: MessageFns<Slide_Element_Build> = {
  encode(message: Slide_Element_Build, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.elementUUID !== undefined) {
      UUID.encode(message.elementUUID, writer.uint32(18).fork()).join();
    }
    if (message.start !== 0) {
    ...
    if (message.transition !== undefined) {
      Transition.encode(message.transition, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_Build {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_Build>, I>>(base?: I): Slide_Element_Build {
...
export const Slide_Element_ChildBuild: MessageFns<Slide_Element_ChildBuild> = {
  encode(message: Slide_Element_ChildBuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.start !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_ChildBuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_ChildBuild>, I>>(base?: I): Slide_Element_ChildBuild {
...
export const Slide_Element_DataLink: MessageFns<Slide_Element_DataLink> = {
  encode(message: Slide_Element_DataLink, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ticker !== undefined) {
      Slide_Element_DataLink_Ticker.encode(message.ticker, writer.uint32(10).fork()).join();
    }
    if (message.alternateText !== undefined) {
      Slide_Element_DataLink_AlternateElementText.encode(message.alternateText, writer.uint32(18).fork()).join();
    }
    if (message.timerText !== undefined) {
      Slide_Element_DataLink_TimerText.encode(message.timerText, writer.uint32(26).fork()).join();
    }
    if (message.clockText !== undefined) {
      Slide_Element_DataLink_ClockText.encode(message.clockText, writer.uint32(34).fork()).join();
    }
    if (message.chordChart !== undefined) {
      Slide_Element_DataLink_ChordChart.encode(message.chordChart, writer.uint32(42).fork()).join();
    }
    if (message.outputScreen !== undefined) {
      Slide_Element_DataLink_OutputScreen.encode(message.outputScreen, writer.uint32(50).fork()).join();
    }
    if (message.pcoLive !== undefined) {
      Slide_Element_DataLink_PCOLive.encode(message.pcoLive, writer.uint32(58).fork()).join();
    }
    if (message.alternateFill !== undefined) {
      Slide_Element_DataLink_AlternateElementFill.encode(message.alternateFill, writer.uint32(66).fork()).join();
    }
    if (message.visibilityLink !== undefined) {
      Slide_Element_DataLink_VisibilityLink.encode(message.visibilityLink, writer.uint32(74).fork()).join();
    }
    if (message.slideText !== undefined) {
      Slide_Element_DataLink_SlideText.encode(message.slideText, writer.uint32(82).fork()).join();
    }
    if (message.stageMessage !== undefined) {
      Slide_Element_DataLink_StageMessage.encode(message.stageMessage, writer.uint32(90).fork()).join();
    }
    if (message.videoCountdown !== undefined) {
      Slide_Element_DataLink_VideoCountdown.encode(message.videoCountdown, writer.uint32(98).fork()).join();
    }
    if (message.slideImage !== undefined) {
      Slide_Element_DataLink_SlideImage.encode(message.slideImage, writer.uint32(106).fork()).join();
    }
    if (message.ccliText !== undefined) {
      Slide_Element_DataLink_CCLIText.encode(message.ccliText, writer.uint32(114).fork()).join();
    }
    if (message.groupName !== undefined) {
      Slide_Element_DataLink_GroupName.encode(message.groupName, writer.uint32(122).fork()).join();
    }
    if (message.groupColor !== undefined) {
      Slide_Element_DataLink_GroupColor.encode(message.groupColor, writer.uint32(130).fork()).join();
    }
    if (message.presentationNotes !== undefined) {
      Slide_Element_DataLink_PresentationNotes.encode(message.presentationNotes, writer.uint32(138).fork()).join();
    }
    if (message.playlistItem !== undefined) {
      Slide_Element_DataLink_PlaylistItem.encode(message.playlistItem, writer.uint32(146).fork()).join();
    }
    ...
    if (message.captureStatusText !== undefined) {
      Slide_Element_DataLink_CaptureStatusText.encode(message.captureStatusText, writer.uint32(162).fork()).join();
    }
    if (message.captureStatusColor !== undefined) {
      Slide_Element_DataLink_CaptureStatusColor.encode(message.captureStatusColor, writer.uint32(170).fork()).join();
    }
    if (message.slideCount !== undefined) {
      Slide_Element_DataLink_SlideCount.encode(message.slideCount, writer.uint32(178).fork()).join();
    }
    if (message.audioCountdown !== undefined) {
      Slide_Element_DataLink_AudioCountdown.encode(message.audioCountdown, writer.uint32(186).fork()).join();
    }
    if (message.presentation !== undefined) {
      Slide_Element_DataLink_Presentation.encode(message.presentation, writer.uint32(194).fork()).join();
    }
    if (message.slideLabelText !== undefined) {
      Slide_Element_DataLink_SlideLabelText.encode(message.slideLabelText, writer.uint32(202).fork()).join();
    }
    if (message.slideLabelColor !== undefined) {
      Slide_Element_DataLink_SlideLabelColor.encode(message.slideLabelColor, writer.uint32(210).fork()).join();
    }
    if (message.rssFeed !== undefined) {
      Slide_Element_DataLink_RSSFeed.encode(message.rssFeed, writer.uint32(218).fork()).join();
    }
    if (message.fileFeed !== undefined) {
      Slide_Element_DataLink_FileFeed.encode(message.fileFeed, writer.uint32(226).fork()).join();
    }
    if (message.chordProChart !== undefined) {
      Slide_Element_DataLink_ChordProChart.encode(message.chordProChart, writer.uint32(234).fork()).join();
    }
    if (message.playbackMarkerText !== undefined) {
      Slide_Element_DataLink_PlaybackMarkerText.encode(message.playbackMarkerText, writer.uint32(242).fork()).join();
    }
    if (message.playbackMarkerColor !== undefined) {
      Slide_Element_DataLink_PlaybackMarkerIdentifier.encode(message.playbackMarkerColor, writer.uint32(258).fork())
        .join();
    }
    if (message.timecodeText !== undefined) {
      Slide_Element_DataLink_TimecodeText.encode(message.timecodeText, writer.uint32(266).fork()).join();
    }
    if (message.timecodeStatus !== undefined) {
      Slide_Element_DataLink_TimecodeStatus.encode(message.timecodeStatus, writer.uint32(274).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 30: {
          ...
          message.playbackMarkerText = Slide_Element_DataLink_PlaybackMarkerText.decode(reader, reader.uint32());
          continue;
        }
        case 32: {
          if (tag !== 258) {
          ...
          message.playbackMarkerColor = Slide_Element_DataLink_PlaybackMarkerIdentifier.decode(reader, reader.uint32());
          continue;
        }
        case 33: {
          if (tag !== 266) {
          ...
          message.timecodeText = Slide_Element_DataLink_TimecodeText.decode(reader, reader.uint32());
          continue;
        }
        case 34: {
          if (tag !== 274) {
          ...
          message.timecodeStatus = Slide_Element_DataLink_TimecodeStatus.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Slide_Element_DataLink {
    return {
      ...
      playbackMarkerText: isSet(object.playbackMarkerText)
        ? Slide_Element_DataLink_PlaybackMarkerText.fromJSON(object.playbackMarkerText)
        : undefined,
      playbackMarkerColor: isSet(object.playbackMarkerColor)
        ? Slide_Element_DataLink_PlaybackMarkerIdentifier.fromJSON(object.playbackMarkerColor)
        : undefined,
  ...
  toJSON(message: Slide_Element_DataLink): unknown {
    ...
    if (message.alternateText !== undefined) {
      obj.alternateText = Slide_Element_DataLink_AlternateElementText.toJSON(message.alternateText);
    }
    if (message.timerText !== undefined) {
      obj.timerText = Slide_Element_DataLink_TimerText.toJSON(message.timerText);
    }
    if (message.clockText !== undefined) {
      obj.clockText = Slide_Element_DataLink_ClockText.toJSON(message.clockText);
    }
    if (message.chordChart !== undefined) {
      obj.chordChart = Slide_Element_DataLink_ChordChart.toJSON(message.chordChart);
    }
    if (message.outputScreen !== undefined) {
      obj.outputScreen = Slide_Element_DataLink_OutputScreen.toJSON(message.outputScreen);
    }
    if (message.pcoLive !== undefined) {
      obj.pcoLive = Slide_Element_DataLink_PCOLive.toJSON(message.pcoLive);
    }
    if (message.alternateFill !== undefined) {
      obj.alternateFill = Slide_Element_DataLink_AlternateElementFill.toJSON(message.alternateFill);
    }
    if (message.visibilityLink !== undefined) {
      obj.visibilityLink = Slide_Element_DataLink_VisibilityLink.toJSON(message.visibilityLink);
    }
    if (message.slideText !== undefined) {
      obj.slideText = Slide_Element_DataLink_SlideText.toJSON(message.slideText);
    }
    if (message.stageMessage !== undefined) {
      obj.stageMessage = Slide_Element_DataLink_StageMessage.toJSON(message.stageMessage);
    }
    if (message.videoCountdown !== undefined) {
      obj.videoCountdown = Slide_Element_DataLink_VideoCountdown.toJSON(message.videoCountdown);
    }
    if (message.slideImage !== undefined) {
      obj.slideImage = Slide_Element_DataLink_SlideImage.toJSON(message.slideImage);
    }
    if (message.ccliText !== undefined) {
      obj.ccliText = Slide_Element_DataLink_CCLIText.toJSON(message.ccliText);
    }
    if (message.groupName !== undefined) {
      obj.groupName = Slide_Element_DataLink_GroupName.toJSON(message.groupName);
    }
    if (message.groupColor !== undefined) {
      obj.groupColor = Slide_Element_DataLink_GroupColor.toJSON(message.groupColor);
    }
    if (message.presentationNotes !== undefined) {
      obj.presentationNotes = Slide_Element_DataLink_PresentationNotes.toJSON(message.presentationNotes);
    }
    if (message.playlistItem !== undefined) {
      obj.playlistItem = Slide_Element_DataLink_PlaylistItem.toJSON(message.playlistItem);
    }
    if (message.autoAdvanceTimeRemaining !== undefined) {
      obj.autoAdvanceTimeRemaining = Slide_Element_DataLink_AutoAdvanceTimeRemaining.toJSON(
        message.autoAdvanceTimeRemaining,
      );
    }
    if (message.captureStatusText !== undefined) {
      obj.captureStatusText = Slide_Element_DataLink_CaptureStatusText.toJSON(message.captureStatusText);
    }
    if (message.captureStatusColor !== undefined) {
      obj.captureStatusColor = Slide_Element_DataLink_CaptureStatusColor.toJSON(message.captureStatusColor);
    }
    if (message.slideCount !== undefined) {
      obj.slideCount = Slide_Element_DataLink_SlideCount.toJSON(message.slideCount);
    }
    if (message.audioCountdown !== undefined) {
      obj.audioCountdown = Slide_Element_DataLink_AudioCountdown.toJSON(message.audioCountdown);
    }
    if (message.presentation !== undefined) {
      obj.presentation = Slide_Element_DataLink_Presentation.toJSON(message.presentation);
    }
    if (message.slideLabelText !== undefined) {
      obj.slideLabelText = Slide_Element_DataLink_SlideLabelText.toJSON(message.slideLabelText);
    }
    if (message.slideLabelColor !== undefined) {
      obj.slideLabelColor = Slide_Element_DataLink_SlideLabelColor.toJSON(message.slideLabelColor);
    }
    if (message.rssFeed !== undefined) {
    ...
    if (message.chordProChart !== undefined) {
      obj.chordProChart = Slide_Element_DataLink_ChordProChart.toJSON(message.chordProChart);
    }
    if (message.playbackMarkerText !== undefined) {
      obj.playbackMarkerText = Slide_Element_DataLink_PlaybackMarkerText.toJSON(message.playbackMarkerText);
    }
    if (message.playbackMarkerColor !== undefined) {
      obj.playbackMarkerColor = Slide_Element_DataLink_PlaybackMarkerIdentifier.toJSON(message.playbackMarkerColor);
    }
    if (message.timecodeText !== undefined) {
      obj.timecodeText = Slide_Element_DataLink_TimecodeText.toJSON(message.timecodeText);
    }
    if (message.timecodeStatus !== undefined) {
      obj.timecodeStatus = Slide_Element_DataLink_TimecodeStatus.toJSON(message.timecodeStatus);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element_DataLink>, I>>(base?: I): Slide_Element_DataLink {
  ...
  fromPartial<I extends Exact<DeepPartial<Slide_Element_DataLink>, I>>(object: I): Slide_Element_DataLink {
    ...
    message.chordProChart = (object.chordProChart !== undefined && object.chordProChart !== null)
      ...
      : undefined;
    message.playbackMarkerText = (object.playbackMarkerText !== undefined && object.playbackMarkerText !== null)
      ? Slide_Element_DataLink_PlaybackMarkerText.fromPartial(object.playbackMarkerText)
      : undefined;
    message.playbackMarkerColor = (object.playbackMarkerColor !== undefined && object.playbackMarkerColor !== null)
      ? Slide_Element_DataLink_PlaybackMarkerIdentifier.fromPartial(object.playbackMarkerColor)
      : undefined;
    message.timecodeText = (object.timecodeText !== undefined && object.timecodeText !== null)
      ? Slide_Element_DataLink_TimecodeText.fromPartial(object.timecodeText)
      : undefined;
    message.timecodeStatus = (object.timecodeStatus !== undefined && object.timecodeStatus !== null)
      ? Slide_Element_DataLink_TimecodeStatus.fromPartial(object.timecodeStatus)
      : undefined;
    return message;
  },
};
...
export const Slide_Element_DataLink_RSSFeed: MessageFns<Slide_Element_DataLink_RSSFeed> = {
  encode(message: Slide_Element_DataLink_RSSFeed, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== undefined) {
      URL.encode(message.url, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_RSSFeed {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_RSSFeed {
    return {
      ...
      textDelimiter: isSet(object.textDelimiter) ? globalThis.String(object.textDelimiter) : "",
    };
  },
  ...
  toJSON(message: Slide_Element_DataLink_RSSFeed): unknown {
    ...
    if (message.content !== 0) {
      obj.content = slide_Element_DataLink_RSSFeed_ContentTypeToJSON(message.content);
    }
    if (message.textDelimiter !== "") {
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_RSSFeed>, I>>(base?: I): Slide_Element_DataLink_RSSFeed {
...
export const Slide_Element_DataLink_FileFeed: MessageFns<Slide_Element_DataLink_FileFeed> = {
  encode(message: Slide_Element_DataLink_FileFeed, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== undefined) {
      URL.encode(message.url, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_FileFeed {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_FileFeed>, I>>(base?: I): Slide_Element_DataLink_FileFeed {
...
export const Slide_Element_DataLink_Ticker: MessageFns<Slide_Element_DataLink_Ticker> = {
  encode(message: Slide_Element_DataLink_Ticker, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.textType !== undefined) {
      Slide_Element_DataLink_Ticker_TextType.encode(message.textType, writer.uint32(10).fork()).join();
    }
    if (message.rssType !== undefined) {
      Slide_Element_DataLink_Ticker_RSSType.encode(message.rssType, writer.uint32(18).fork()).join();
    }
    if (message.fileType !== undefined) {
      Slide_Element_DataLink_Ticker_FileType.encode(message.fileType, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_Ticker {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_Ticker {
    return {
      ...
      loopDelay: isSet(object.loopDelay) ? globalThis.Number(object.loopDelay) : 0,
      textDelimiter: isSet(object.textDelimiter) ? globalThis.String(object.textDelimiter) : "",
  ...
  toJSON(message: Slide_Element_DataLink_Ticker): unknown {
    ...
    if (message.textType !== undefined) {
      obj.textType = Slide_Element_DataLink_Ticker_TextType.toJSON(message.textType);
    }
    if (message.rssType !== undefined) {
      obj.rssType = Slide_Element_DataLink_Ticker_RSSType.toJSON(message.rssType);
    }
    if (message.fileType !== undefined) {
      obj.fileType = Slide_Element_DataLink_Ticker_FileType.toJSON(message.fileType);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element_DataLink_Ticker>, I>>(base?: I): Slide_Element_DataLink_Ticker {
...
export const Slide_Element_DataLink_Ticker_TextType: MessageFns<Slide_Element_DataLink_Ticker_TextType> = {
  encode(message: Slide_Element_DataLink_Ticker_TextType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.text !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_Ticker_TextType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_Ticker_TextType>, I>>(
    base?: I,
  ): Slide_Element_DataLink_Ticker_TextType {
    return Slide_Element_DataLink_Ticker_TextType.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_Ticker_RSSType: MessageFns<Slide_Element_DataLink_Ticker_RSSType> = {
  encode(message: Slide_Element_DataLink_Ticker_RSSType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== undefined) {
      URL.encode(message.url, writer.uint32(10).fork()).join();
    }
    if (message.content !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_Ticker_RSSType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_Ticker_RSSType>, I>>(
    base?: I,
  ): Slide_Element_DataLink_Ticker_RSSType {
    return Slide_Element_DataLink_Ticker_RSSType.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_Ticker_FileType: MessageFns<Slide_Element_DataLink_Ticker_FileType> = {
  encode(message: Slide_Element_DataLink_Ticker_FileType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== undefined) {
      URL.encode(message.url, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_Ticker_FileType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_Ticker_FileType>, I>>(
    base?: I,
  ): Slide_Element_DataLink_Ticker_FileType {
    return Slide_Element_DataLink_Ticker_FileType.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_AlternateElementText: MessageFns<Slide_Element_DataLink_AlternateElementText> = {
  encode(
    message: Slide_Element_DataLink_AlternateElementText,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.otherElementUuid !== undefined) {
      UUID.encode(message.otherElementUuid, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_AlternateElementText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_AlternateElementText {
    return {
      ...
      otherElementName: isSet(object.otherElementName) ? globalThis.String(object.otherElementName) : "",
      textTransformOptions: isSet(object.textTransformOptions) ? globalThis.Number(object.textTransformOptions) : 0,
  ...
  toJSON(message: Slide_Element_DataLink_AlternateElementText): unknown {
    ...
    if (message.textTransform !== 0) {
      obj.textTransform = slide_Element_DataLink_AlternateElementText_TextTransformOptionToJSON(message.textTransform);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element_DataLink_AlternateElementText>, I>>(
    base?: I,
  ): Slide_Element_DataLink_AlternateElementText {
    return Slide_Element_DataLink_AlternateElementText.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_CCLIText: MessageFns<Slide_Element_DataLink_CCLIText> = {
  encode(_: Slide_Element_DataLink_CCLIText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_CCLIText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_CCLIText>, I>>(base?: I): Slide_Element_DataLink_CCLIText {
...
export const Slide_Element_DataLink_ColorTrigger: MessageFns<Slide_Element_DataLink_ColorTrigger> = {
  encode(message: Slide_Element_DataLink_ColorTrigger, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.time !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_ColorTrigger {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Slide_Element_DataLink_TimerText: MessageFns<Slide_Element_DataLink_TimerText> = {
  encode(message: Slide_Element_DataLink_TimerText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.timerUuid !== undefined) {
      UUID.encode(message.timerUuid, writer.uint32(10).fork()).join();
    }
    if (message.timerName !== "") {
      writer.uint32(18).string(message.timerName);
    }
    if (message.timerFormat !== undefined) {
      Timer_Format.encode(message.timerFormat, writer.uint32(26).fork()).join();
    }
    if (message.timerFormatString !== "") {
      writer.uint32(34).string(message.timerFormatString);
    }
    for (const v of message.colorTriggers) {
      Slide_Element_DataLink_ColorTrigger.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_TimerText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_TimerText {
    return {
      ...
      timerName: isSet(object.timerName) ? globalThis.String(object.timerName) : "",
      timerFormat: isSet(object.timerFormat) ? Timer_Format.fromJSON(object.timerFormat) : undefined,
      timerFormatString: isSet(object.timerFormatString) ? globalThis.String(object.timerFormatString) : "",
  ...
  toJSON(message: Slide_Element_DataLink_TimerText): unknown {
    ...
    if (message.colorTriggers?.length) {
      obj.colorTriggers = message.colorTriggers.map((e) => Slide_Element_DataLink_ColorTrigger.toJSON(e));
    }
    return obj;
  },
...
export const Slide_Element_DataLink_ClockText: MessageFns<Slide_Element_DataLink_ClockText> = {
  encode(message: Slide_Element_DataLink_ClockText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.clockFormatString !== "") {
      writer.uint32(10).string(message.clockFormatString);
    }
    if (message.format !== undefined) {
      Clock_Format.encode(message.format, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_ClockText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_ClockText {
    return {
      clockFormatString: isSet(object.clockFormatString) ? globalThis.String(object.clockFormatString) : "",
...
export const Slide_Element_DataLink_ChordChart: MessageFns<Slide_Element_DataLink_ChordChart> = {
  encode(_: Slide_Element_DataLink_ChordChart, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_ChordChart {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Slide_Element_DataLink_OutputScreen: MessageFns<Slide_Element_DataLink_OutputScreen> = {
  encode(message: Slide_Element_DataLink_OutputScreen, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.screenId !== undefined) {
      UUID.encode(message.screenId, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_OutputScreen {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Slide_Element_DataLink_PCOLive: MessageFns<Slide_Element_DataLink_PCOLive> = {
  encode(message: Slide_Element_DataLink_PCOLive, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.theme !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_PCOLive {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_PCOLive>, I>>(base?: I): Slide_Element_DataLink_PCOLive {
...
export const Slide_Element_DataLink_AlternateElementFill: MessageFns<Slide_Element_DataLink_AlternateElementFill> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_AlternateElementFill {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_AlternateElementFill>, I>>(
    base?: I,
  ): Slide_Element_DataLink_AlternateElementFill {
    return Slide_Element_DataLink_AlternateElementFill.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_VisibilityLink: MessageFns<Slide_Element_DataLink_VisibilityLink> = {
  encode(message: Slide_Element_DataLink_VisibilityLink, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.visibilityCriterion !== 0) {
      writer.uint32(8).int32(message.visibilityCriterion);
    }
    for (const v of message.conditions) {
      Slide_Element_DataLink_VisibilityLink_Condition.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_VisibilityLink {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Slide_Element_DataLink_VisibilityLink): unknown {
    ...
    if (message.conditions?.length) {
      obj.conditions = message.conditions.map((e) => Slide_Element_DataLink_VisibilityLink_Condition.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink {
    return Slide_Element_DataLink_VisibilityLink.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_VisibilityLink_Condition: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_VisibilityLink_Condition {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Slide_Element_DataLink_VisibilityLink_Condition): unknown {
    const obj: any = {};
    if (message.elementVisibility !== undefined) {
      obj.elementVisibility = Slide_Element_DataLink_VisibilityLink_Condition_ElementVisibility.toJSON(
        message.elementVisibility,
      );
    }
    if (message.timerVisibility !== undefined) {
      obj.timerVisibility = Slide_Element_DataLink_VisibilityLink_Condition_TimerVisibility.toJSON(
        message.timerVisibility,
      );
    }
    if (message.videoCountdownVisibility !== undefined) {
      obj.videoCountdownVisibility = Slide_Element_DataLink_VisibilityLink_Condition_VideoCountdownVisibility.toJSON(
        message.videoCountdownVisibility,
      );
    }
    if (message.captureSessionVisibility !== undefined) {
      obj.captureSessionVisibility = Slide_Element_DataLink_VisibilityLink_Condition_CaptureSessionVisibility.toJSON(
        message.captureSessionVisibility,
      );
    }
    if (message.videoInputVisibility !== undefined) {
      obj.videoInputVisibility = Slide_Element_DataLink_VisibilityLink_Condition_VideoInputVisibility.toJSON(
        message.videoInputVisibility,
      );
    }
    if (message.audioCountdownVisibility !== undefined) {
      obj.audioCountdownVisibility = Slide_Element_DataLink_VisibilityLink_Condition_AudioCountdownVisibility.toJSON(
        message.audioCountdownVisibility,
      );
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink_Condition>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink_Condition {
    return Slide_Element_DataLink_VisibilityLink_Condition.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_VisibilityLink_Condition_ElementVisibility: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink_Condition_ElementVisibility>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink_Condition_ElementVisibility {
    return Slide_Element_DataLink_VisibilityLink_Condition_ElementVisibility.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_VisibilityLink_Condition_TimerVisibility: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink_Condition_TimerVisibility>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink_Condition_TimerVisibility {
    return Slide_Element_DataLink_VisibilityLink_Condition_TimerVisibility.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_VisibilityLink_Condition_VideoCountdownVisibility: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink_Condition_VideoCountdownVisibility>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink_Condition_VideoCountdownVisibility {
    return Slide_Element_DataLink_VisibilityLink_Condition_VideoCountdownVisibility.fromPartial(base ?? ({} as any));
  },
  fromPartial<
...
export const Slide_Element_DataLink_VisibilityLink_Condition_AudioCountdownVisibility: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink_Condition_AudioCountdownVisibility>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink_Condition_AudioCountdownVisibility {
    return Slide_Element_DataLink_VisibilityLink_Condition_AudioCountdownVisibility.fromPartial(base ?? ({} as any));
  },
  fromPartial<
...
export const Slide_Element_DataLink_VisibilityLink_Condition_CaptureSessionVisibility: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink_Condition_CaptureSessionVisibility>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink_Condition_CaptureSessionVisibility {
    return Slide_Element_DataLink_VisibilityLink_Condition_CaptureSessionVisibility.fromPartial(base ?? ({} as any));
  },
  fromPartial<
...
export const Slide_Element_DataLink_VisibilityLink_Condition_VideoInputVisibility: MessageFns<
...
> = {
  ...
  fromJSON(object: any): Slide_Element_DataLink_VisibilityLink_Condition_VideoInputVisibility {
    return {
      videoInputIndex: isSet(object.videoInputIndex) ? globalThis.Number(object.videoInputIndex) : 0,
      visibilityCriterion: isSet(object.visibilityCriterion)
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VisibilityLink_Condition_VideoInputVisibility>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VisibilityLink_Condition_VideoInputVisibility {
    return Slide_Element_DataLink_VisibilityLink_Condition_VideoInputVisibility.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_SlideText: MessageFns<Slide_Element_DataLink_SlideText> = {
  encode(message: Slide_Element_DataLink_SlideText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_SlideText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_SlideText {
    return {
      sourceSlide: isSet(object.sourceSlide) ? slide_Element_DataLink_SlideSourceTypeFromJSON(object.sourceSlide) : 0,
      sourceOption: isSet(object.sourceOption)
        ? slide_Element_DataLink_SlideText_TextSourceOptionFromJSON(object.sourceOption)
        : 0,
      preserveNotesFormat: isSet(object.preserveNotesFormat) ? globalThis.Boolean(object.preserveNotesFormat) : false,
      nameToMatch: isSet(object.nameToMatch) ? globalThis.String(object.nameToMatch) : "",
      elementTextTransform: isSet(object.elementTextTransform)
        ? slide_Element_DataLink_AlternateElementText_TextTransformOptionFromJSON(object.elementTextTransform)
        : 0,
    };
  },
  ...
  toJSON(message: Slide_Element_DataLink_SlideText): unknown {
    const obj: any = {};
    if (message.sourceSlide !== 0) {
      obj.sourceSlide = slide_Element_DataLink_SlideSourceTypeToJSON(message.sourceSlide);
    }
    if (message.sourceOption !== 0) {
    ...
    if (message.elementTextTransform !== 0) {
      obj.elementTextTransform = slide_Element_DataLink_AlternateElementText_TextTransformOptionToJSON(
...
export const Slide_Element_DataLink_SlideImage: MessageFns<Slide_Element_DataLink_SlideImage> = {
  encode(message: Slide_Element_DataLink_SlideImage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sourceSlide !== 0) {
      writer.uint32(8).int32(message.sourceSlide);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_SlideImage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Slide_Element_DataLink_StageMessage: MessageFns<Slide_Element_DataLink_StageMessage> = {
  encode(message: Slide_Element_DataLink_StageMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.shouldFlash !== false) {
      writer.uint32(8).bool(message.shouldFlash);
    }
    if (message.flashColor !== undefined) {
      Color.encode(message.flashColor, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_StageMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_StageMessage {
    return {
      shouldFlash: isSet(object.shouldFlash) ? globalThis.Boolean(object.shouldFlash) : false,
...
export const Slide_Element_DataLink_VideoCountdown: MessageFns<Slide_Element_DataLink_VideoCountdown> = {
  encode(message: Slide_Element_DataLink_VideoCountdown, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.timerFormat !== undefined) {
      Timer_Format.encode(message.timerFormat, writer.uint32(10).fork()).join();
    }
    if (message.timerFormatString !== "") {
      writer.uint32(18).string(message.timerFormatString);
    }
    for (const v of message.colorTriggers) {
      Slide_Element_DataLink_ColorTrigger.encode(v!, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_VideoCountdown {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_VideoCountdown {
    return {
      ...
      colorTriggers: globalThis.Array.isArray(object?.colorTriggers)
        ? object.colorTriggers.map((e: any) => Slide_Element_DataLink_ColorTrigger.fromJSON(e))
        : [],
      ignoreLoopingVideos: isSet(object.ignoreLoopingVideos) ? globalThis.Boolean(object.ignoreLoopingVideos) : false,
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_VideoCountdown>, I>>(
    base?: I,
  ): Slide_Element_DataLink_VideoCountdown {
    return Slide_Element_DataLink_VideoCountdown.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_AudioCountdown: MessageFns<Slide_Element_DataLink_AudioCountdown> = {
  encode(message: Slide_Element_DataLink_AudioCountdown, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.timerFormat !== undefined) {
      Timer_Format.encode(message.timerFormat, writer.uint32(10).fork()).join();
    }
    if (message.timerFormatString !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_AudioCountdown {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_AudioCountdown {
    return {
      ...
      colorTriggers: globalThis.Array.isArray(object?.colorTriggers)
        ? object.colorTriggers.map((e: any) => Slide_Element_DataLink_ColorTrigger.fromJSON(e))
        : [],
      ignoreLoopingAudio: isSet(object.ignoreLoopingAudio) ? globalThis.Boolean(object.ignoreLoopingAudio) : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_AudioCountdown>, I>>(
    base?: I,
  ): Slide_Element_DataLink_AudioCountdown {
    return Slide_Element_DataLink_AudioCountdown.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_GroupName: MessageFns<Slide_Element_DataLink_GroupName> = {
  encode(message: Slide_Element_DataLink_GroupName, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_GroupName {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_GroupName {
    return {
      groupSource: isSet(object.groupSource) ? slide_Element_DataLink_GroupSourceTypeFromJSON(object.groupSource) : 0,
    };
  },
  ...
  toJSON(message: Slide_Element_DataLink_GroupName): unknown {
    const obj: any = {};
    if (message.groupSource !== 0) {
      obj.groupSource = slide_Element_DataLink_GroupSourceTypeToJSON(message.groupSource);
    }
    return obj;
  },
...
export const Slide_Element_DataLink_GroupColor: MessageFns<Slide_Element_DataLink_GroupColor> = {
  encode(message: Slide_Element_DataLink_GroupColor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.groupSource !== 0) {
      writer.uint32(8).int32(message.groupSource);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_GroupColor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Slide_Element_DataLink_SlideLabelText: MessageFns<Slide_Element_DataLink_SlideLabelText> = {
  encode(message: Slide_Element_DataLink_SlideLabelText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_SlideLabelText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_SlideLabelText {
    return {
      slideLabelSource: isSet(object.slideLabelSource)
        ? slide_Element_DataLink_SlideLabelSourceFromJSON(object.slideLabelSource)
        : 0,
    };
  },
  ...
  toJSON(message: Slide_Element_DataLink_SlideLabelText): unknown {
    const obj: any = {};
    if (message.slideLabelSource !== 0) {
      obj.slideLabelSource = slide_Element_DataLink_SlideLabelSourceToJSON(message.slideLabelSource);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element_DataLink_SlideLabelText>, I>>(
    base?: I,
  ): Slide_Element_DataLink_SlideLabelText {
    return Slide_Element_DataLink_SlideLabelText.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_SlideLabelColor: MessageFns<Slide_Element_DataLink_SlideLabelColor> = {
  encode(message: Slide_Element_DataLink_SlideLabelColor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.slideLabelSource !== 0) {
      writer.uint32(8).int32(message.slideLabelSource);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_SlideLabelColor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_SlideLabelColor>, I>>(
    base?: I,
  ): Slide_Element_DataLink_SlideLabelColor {
    return Slide_Element_DataLink_SlideLabelColor.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_PresentationNotes: MessageFns<Slide_Element_DataLink_PresentationNotes> = {
  encode(_: Slide_Element_DataLink_PresentationNotes, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_PresentationNotes {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_PresentationNotes>, I>>(
    base?: I,
  ): Slide_Element_DataLink_PresentationNotes {
    return Slide_Element_DataLink_PresentationNotes.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_Presentation: MessageFns<Slide_Element_DataLink_Presentation> = {
  encode(message: Slide_Element_DataLink_Presentation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_Presentation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Slide_Element_DataLink_Presentation): unknown {
    const obj: any = {};
    if (message.presentationSource !== 0) {
      obj.presentationSource = slide_Element_DataLink_Presentation_PresentationSourceToJSON(message.presentationSource);
    }
    return obj;
  },
...
export const Slide_Element_DataLink_PlaylistItem: MessageFns<Slide_Element_DataLink_PlaylistItem> = {
  encode(message: Slide_Element_DataLink_PlaylistItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_PlaylistItem {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_PlaylistItem {
    return {
      playlistItemSource: isSet(object.playlistItemSource)
        ...
        : 0,
      showArrangement: isSet(object.showArrangement) ? globalThis.Boolean(object.showArrangement) : false,
    };
  },
...
export const Slide_Element_DataLink_AutoAdvanceTimeRemaining: MessageFns<
...
> = {
  encode(
    ...
    if (message.timerFormat !== undefined) {
      Timer_Format.encode(message.timerFormat, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_AutoAdvanceTimeRemaining {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_AutoAdvanceTimeRemaining>, I>>(
    base?: I,
  ): Slide_Element_DataLink_AutoAdvanceTimeRemaining {
    return Slide_Element_DataLink_AutoAdvanceTimeRemaining.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_CaptureStatusText: MessageFns<Slide_Element_DataLink_CaptureStatusText> = {
  encode(message: Slide_Element_DataLink_CaptureStatusText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.statusText !== undefined) {
      Slide_Element_DataLink_CaptureStatusText_StatusText.encode(message.statusText, writer.uint32(10).fork()).join();
    }
    if (message.elapsedTime !== undefined) {
      Slide_Element_DataLink_CaptureStatusText_ElapsedTime.encode(message.elapsedTime, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_CaptureStatusText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Slide_Element_DataLink_CaptureStatusText): unknown {
    const obj: any = {};
    if (message.statusText !== undefined) {
      obj.statusText = Slide_Element_DataLink_CaptureStatusText_StatusText.toJSON(message.statusText);
    }
    if (message.elapsedTime !== undefined) {
      obj.elapsedTime = Slide_Element_DataLink_CaptureStatusText_ElapsedTime.toJSON(message.elapsedTime);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element_DataLink_CaptureStatusText>, I>>(
    base?: I,
  ): Slide_Element_DataLink_CaptureStatusText {
    return Slide_Element_DataLink_CaptureStatusText.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_CaptureStatusText_StatusText: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_CaptureStatusText_StatusText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_CaptureStatusText_StatusText>, I>>(
    base?: I,
  ): Slide_Element_DataLink_CaptureStatusText_StatusText {
    return Slide_Element_DataLink_CaptureStatusText_StatusText.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_CaptureStatusText_ElapsedTime: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_CaptureStatusText_ElapsedTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_CaptureStatusText_ElapsedTime>, I>>(
    base?: I,
  ): Slide_Element_DataLink_CaptureStatusText_ElapsedTime {
    return Slide_Element_DataLink_CaptureStatusText_ElapsedTime.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_CaptureStatusColor: MessageFns<Slide_Element_DataLink_CaptureStatusColor> = {
  encode(_: Slide_Element_DataLink_CaptureStatusColor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_CaptureStatusColor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_CaptureStatusColor>, I>>(
    base?: I,
  ): Slide_Element_DataLink_CaptureStatusColor {
    return Slide_Element_DataLink_CaptureStatusColor.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_SlideCount: MessageFns<Slide_Element_DataLink_SlideCount> = {
  encode(message: Slide_Element_DataLink_SlideCount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_SlideCount {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Slide_Element_DataLink_PlaybackMarkerIdentifier: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_PlaybackMarkerIdentifier {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_PlaybackMarkerIdentifier {
    return {
      destination: isSet(object.destination)
        ? slide_Element_DataLink_PlaybackMarkerIdentifier_DestinationFromJSON(object.destination)
        : 0,
      type: isSet(object.type) ? slide_Element_DataLink_PlaybackMarkerIdentifier_TypeFromJSON(object.type) : 0,
  ...
  toJSON(message: Slide_Element_DataLink_PlaybackMarkerIdentifier): unknown {
    const obj: any = {};
    if (message.destination !== 0) {
      obj.destination = slide_Element_DataLink_PlaybackMarkerIdentifier_DestinationToJSON(message.destination);
    }
    if (message.type !== 0) {
      obj.type = slide_Element_DataLink_PlaybackMarkerIdentifier_TypeToJSON(message.type);
    }
    if (message.name !== "") {
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerIdentifier>, I>>(
    base?: I,
  ): Slide_Element_DataLink_PlaybackMarkerIdentifier {
    return Slide_Element_DataLink_PlaybackMarkerIdentifier.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerIdentifier>, I>>(
    object: I,
  ): Slide_Element_DataLink_PlaybackMarkerIdentifier {
    const message = createBaseSlide_Element_DataLink_PlaybackMarkerIdentifier();
...
function createBaseSlide_Element_DataLink_PlaybackMarkerText(): Slide_Element_DataLink_PlaybackMarkerText {
  return { identifier: undefined, shouldUseMarkerColor: false, name: undefined, time: undefined };
}

export const Slide_Element_DataLink_PlaybackMarkerText: MessageFns<Slide_Element_DataLink_PlaybackMarkerText> = {
  encode(message: Slide_Element_DataLink_PlaybackMarkerText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identifier !== undefined) {
      Slide_Element_DataLink_PlaybackMarkerIdentifier.encode(message.identifier, writer.uint32(10).fork()).join();
    }
    if (message.shouldUseMarkerColor !== false) {
      writer.uint32(32).bool(message.shouldUseMarkerColor);
    }
    if (message.name !== undefined) {
      Slide_Element_DataLink_PlaybackMarkerText_Name.encode(message.name, writer.uint32(18).fork()).join();
    }
    if (message.time !== undefined) {
      Slide_Element_DataLink_PlaybackMarkerText_Time.encode(message.time, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_PlaybackMarkerText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.identifier = Slide_Element_DataLink_PlaybackMarkerIdentifier.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 32) {
        ...
        case 2: {
          ...
          message.name = Slide_Element_DataLink_PlaybackMarkerText_Name.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.time = Slide_Element_DataLink_PlaybackMarkerText_Time.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Slide_Element_DataLink_PlaybackMarkerText {
    return {
      identifier: isSet(object.identifier)
        ? Slide_Element_DataLink_PlaybackMarkerIdentifier.fromJSON(object.identifier)
        : undefined,
      shouldUseMarkerColor: isSet(object.shouldUseMarkerColor)
        ? globalThis.Boolean(object.shouldUseMarkerColor)
        : false,
      name: isSet(object.name) ? Slide_Element_DataLink_PlaybackMarkerText_Name.fromJSON(object.name) : undefined,
      time: isSet(object.time) ? Slide_Element_DataLink_PlaybackMarkerText_Time.fromJSON(object.time) : undefined,
    };
  },
  ...
  toJSON(message: Slide_Element_DataLink_PlaybackMarkerText): unknown {
    const obj: any = {};
    if (message.identifier !== undefined) {
      obj.identifier = Slide_Element_DataLink_PlaybackMarkerIdentifier.toJSON(message.identifier);
    }
    if (message.shouldUseMarkerColor !== false) {
      obj.shouldUseMarkerColor = message.shouldUseMarkerColor;
    }
    if (message.name !== undefined) {
      obj.name = Slide_Element_DataLink_PlaybackMarkerText_Name.toJSON(message.name);
    }
    if (message.time !== undefined) {
      obj.time = Slide_Element_DataLink_PlaybackMarkerText_Time.toJSON(message.time);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerText>, I>>(
    base?: I,
  ): Slide_Element_DataLink_PlaybackMarkerText {
    return Slide_Element_DataLink_PlaybackMarkerText.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerText>, I>>(
    object: I,
  ): Slide_Element_DataLink_PlaybackMarkerText {
    const message = createBaseSlide_Element_DataLink_PlaybackMarkerText();
    message.identifier = (object.identifier !== undefined && object.identifier !== null)
      ? Slide_Element_DataLink_PlaybackMarkerIdentifier.fromPartial(object.identifier)
      : undefined;
    message.shouldUseMarkerColor = object.shouldUseMarkerColor ?? false;
    message.name = (object.name !== undefined && object.name !== null)
      ? Slide_Element_DataLink_PlaybackMarkerText_Name.fromPartial(object.name)
      : undefined;
    message.time = (object.time !== undefined && object.time !== null)
      ? Slide_Element_DataLink_PlaybackMarkerText_Time.fromPartial(object.time)
      : undefined;
    return message;
  },
};
...
export const Slide_Element_DataLink_PlaybackMarkerText_Name: MessageFns<
  Slide_Element_DataLink_PlaybackMarkerText_Name
> = {
  encode(_: Slide_Element_DataLink_PlaybackMarkerText_Name, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_PlaybackMarkerText_Name {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerText_Name>, I>>(
    base?: I,
  ): Slide_Element_DataLink_PlaybackMarkerText_Name {
    return Slide_Element_DataLink_PlaybackMarkerText_Name.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerText_Name>, I>>(
    _: I,
  ): Slide_Element_DataLink_PlaybackMarkerText_Name {
    const message = createBaseSlide_Element_DataLink_PlaybackMarkerText_Name();
    return message;
...
export const Slide_Element_DataLink_PlaybackMarkerText_Time: MessageFns<
...
> = {
  encode(
    ...
    if (message.format !== undefined) {
      Timer_Format.encode(message.format, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_PlaybackMarkerText_Time {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_DataLink_PlaybackMarkerText_Time {
    return { format: isSet(object.format) ? Timer_Format.fromJSON(object.format) : undefined };
  },
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerText_Time>, I>>(
    base?: I,
  ): Slide_Element_DataLink_PlaybackMarkerText_Time {
    return Slide_Element_DataLink_PlaybackMarkerText_Time.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Slide_Element_DataLink_PlaybackMarkerText_Time>, I>>(
    object: I,
  ): Slide_Element_DataLink_PlaybackMarkerText_Time {
    const message = createBaseSlide_Element_DataLink_PlaybackMarkerText_Time();
    message.format = (object.format !== undefined && object.format !== null)
...
export const Slide_Element_DataLink_ChordProChart: MessageFns<Slide_Element_DataLink_ChordProChart> = {
  encode(_: Slide_Element_DataLink_ChordProChart, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_ChordProChart {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_ChordProChart>, I>>(
    ...
    return Slide_Element_DataLink_ChordProChart.fromPartial(base ?? ({} as any));
  },
...
export const Slide_Element_DataLink_TimecodeText: MessageFns<Slide_Element_DataLink_TimecodeText> = {
  encode(_: Slide_Element_DataLink_TimecodeText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_TimecodeText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<Slide_Element_DataLink_TimecodeText>, I>>(
    _: I,
  ): Slide_Element_DataLink_TimecodeText {
    const message = createBaseSlide_Element_DataLink_TimecodeText();
    return message;
...
export const Slide_Element_DataLink_TimecodeStatus: MessageFns<Slide_Element_DataLink_TimecodeStatus> = {
  encode(_: Slide_Element_DataLink_TimecodeStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_DataLink_TimecodeStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Slide_Element_DataLink_TimecodeStatus>, I>>(
    base?: I,
  ): Slide_Element_DataLink_TimecodeStatus {
    return Slide_Element_DataLink_TimecodeStatus.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Slide_Element_DataLink_TimecodeStatus>, I>>(
    _: I,
  ): Slide_Element_DataLink_TimecodeStatus {
    const message = createBaseSlide_Element_DataLink_TimecodeStatus();
    return message;
...
export const Slide_Element_TextScroller: MessageFns<Slide_Element_TextScroller> = {
  encode(message: Slide_Element_TextScroller, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Slide_Element_TextScroller {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Slide_Element_TextScroller {
    return {
      shouldScroll: isSet(object.shouldScroll) ? globalThis.Boolean(object.shouldScroll) : false,
      scrollRate: isSet(object.scrollRate) ? globalThis.Number(object.scrollRate) : 0,
      shouldRepeat: isSet(object.shouldRepeat) ? globalThis.Boolean(object.shouldRepeat) : false,
      repeatDistance: isSet(object.repeatDistance) ? globalThis.Number(object.repeatDistance) : 0,
      scrollingDirection: isSet(object.scrollingDirection)
        ? slide_Element_TextScroller_DirectionFromJSON(object.scrollingDirection)
        : 0,
      startsOffScreen: isSet(object.startsOffScreen) ? globalThis.Boolean(object.startsOffScreen) : false,
      fadeLeft: isSet(object.fadeLeft) ? globalThis.Number(object.fadeLeft) : 0,
      fadeRight: isSet(object.fadeRight) ? globalThis.Number(object.fadeRight) : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Slide_Element_TextScroller>, I>>(base?: I): Slide_Element_TextScroller {
