...
export const Layer: MessageFns<Layer> = {
  encode(message: Layer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.selectedTargetSetUuid !== undefined) {
      UUID.encode(message.selectedTargetSetUuid, writer.uint32(66).fork()).join();
    }
    if (message.effectsPresetUuid !== undefined) {
      UUID.encode(message.effectsPresetUuid, writer.uint32(74).fork()).join();
    }
    ...
    if (message.layerPresetUuid !== undefined) {
      UUID.encode(message.layerPresetUuid, writer.uint32(90).fork()).join();
    }
    if (message.hotKey !== undefined) {
      HotKey.encode(message.hotKey, writer.uint32(98).fork()).join();
    }
    if (message.transition !== undefined) {
      Transition.encode(message.transition, writer.uint32(106).fork()).join();
    }
    for (const v of message.effects) {
      Effect.encode(v!, writer.uint32(114).fork()).join();
    }
    if (message.blend !== undefined) {
      Layer_Blending.encode(message.blend, writer.uint32(122).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Layer {
    return {
      ...
      effectsBuildDuration: isSet(object.effectsBuildDuration) ? globalThis.Number(object.effectsBuildDuration) : 0,
...
export const Layer_Preset: MessageFns<Layer_Preset> = {
  encode(message: Layer_Preset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.name !== "") {
    ...
    if (message.layer !== undefined) {
      Layer.encode(message.layer, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Layer_Preset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Layer_Blending: MessageFns<Layer_Blending> = {
  encode(message: Layer_Blending, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.standard !== undefined) {
      Layer_Blending_Standard.encode(message.standard, writer.uint32(10).fork()).join();
    }
    if (message.matte !== undefined) {
      Layer_Blending_Matte.encode(message.matte, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Layer_Blending {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Layer_Blending_Standard: MessageFns<Layer_Blending_Standard> = {
  encode(message: Layer_Blending_Standard, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.mode !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Layer_Blending_Standard {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Layer_Blending_Matte: MessageFns<Layer_Blending_Matte> = {
  encode(message: Layer_Blending_Matte, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.alpha !== undefined) {
      Layer_Blending_Matte_Alpha.encode(message.alpha, writer.uint32(10).fork()).join();
    }
    if (message.luma !== undefined) {
      Layer_Blending_Matte_Luma.encode(message.luma, writer.uint32(18).fork()).join();
    }
    if (message.white !== undefined) {
      Layer_Blending_Matte_White.encode(message.white, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Layer_Blending_Matte {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Layer_Blending_Matte_Alpha: MessageFns<Layer_Blending_Matte_Alpha> = {
  encode(message: Layer_Blending_Matte_Alpha, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Layer_Blending_Matte_Alpha {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Layer_Blending_Matte_Alpha {
    return { inverted: isSet(object.inverted) ? globalThis.Boolean(object.inverted) : false };
  },
...
export const Layer_Blending_Matte_Luma: MessageFns<Layer_Blending_Matte_Luma> = {
  encode(message: Layer_Blending_Matte_Luma, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.inverted !== false) {
      writer.uint32(8).bool(message.inverted);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Layer_Blending_Matte_Luma {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Layer_Blending_Matte_White: MessageFns<Layer_Blending_Matte_White> = {
  encode(_: Layer_Blending_Matte_White, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Layer_Blending_Matte_White {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
