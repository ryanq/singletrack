...
export const Clock: MessageFns<Clock> = {
  encode(message: Clock, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.format !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Clock {
...
export const Clock_Format: MessageFns<Clock_Format> = {
  encode(message: Clock_Format, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Clock_Format {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Clock_Format {
    return {
      ...
      militaryTimeEnabled: isSet(object.militaryTimeEnabled) ? globalThis.Boolean(object.militaryTimeEnabled) : false,
    };
  },
  ...
  toJSON(message: Clock_Format): unknown {
    ...
    if (message.timeFormat !== 0) {
      obj.timeFormat = clock_Format_DateFormatterStyleToJSON(message.timeFormat);
    }
    if (message.militaryTimeEnabled !== false) {
  ...
  create<I extends Exact<DeepPartial<Clock_Format>, I>>(base?: I): Clock_Format {
...
export const Timer: MessageFns<Timer> = {
  encode(message: Timer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.configuration !== undefined) {
      Timer_Configuration.encode(message.configuration, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Timer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Timer_Format: MessageFns<Timer_Format> = {
  encode(message: Timer_Format, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hour !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Timer_Format {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Timer_Format {
    return {
      ...
      isWallClockTime: isSet(object.isWallClockTime) ? globalThis.Boolean(object.isWallClockTime) : false,
      is24HourTime: isSet(object.is24HourTime) ? globalThis.Boolean(object.is24HourTime) : false,
  ...
  create<I extends Exact<DeepPartial<Timer_Format>, I>>(base?: I): Timer_Format {
...
export const Timer_Configuration: MessageFns<Timer_Configuration> = {
  encode(message: Timer_Configuration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.allowsOverrun !== false) {
      writer.uint32(32).bool(message.allowsOverrun);
    }
    if (message.countdown !== undefined) {
      Timer_Configuration_TimerTypeCountdown.encode(message.countdown, writer.uint32(10).fork()).join();
    }
    if (message.countdownToTime !== undefined) {
      Timer_Configuration_TimerTypeCountdownToTime.encode(message.countdownToTime, writer.uint32(18).fork()).join();
    }
    if (message.elapsedTime !== undefined) {
      Timer_Configuration_TimerTypeElapsedTime.encode(message.elapsedTime, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Timer_Configuration {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Timer_Configuration {
    return {
      allowsOverrun: isSet(object.allowsOverrun) ? globalThis.Boolean(object.allowsOverrun) : false,
  ...
  toJSON(message: Timer_Configuration): unknown {
    ...
    if (message.countdown !== undefined) {
      obj.countdown = Timer_Configuration_TimerTypeCountdown.toJSON(message.countdown);
    }
    if (message.countdownToTime !== undefined) {
      obj.countdownToTime = Timer_Configuration_TimerTypeCountdownToTime.toJSON(message.countdownToTime);
    }
    if (message.elapsedTime !== undefined) {
      obj.elapsedTime = Timer_Configuration_TimerTypeElapsedTime.toJSON(message.elapsedTime);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Timer_Configuration>, I>>(base?: I): Timer_Configuration {
...
export const Timer_Configuration_TimerTypeCountdown: MessageFns<Timer_Configuration_TimerTypeCountdown> = {
  encode(message: Timer_Configuration_TimerTypeCountdown, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Timer_Configuration_TimerTypeCountdown {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Timer_Configuration_TimerTypeCountdown>, I>>(
    base?: I,
  ): Timer_Configuration_TimerTypeCountdown {
    return Timer_Configuration_TimerTypeCountdown.fromPartial(base ?? ({} as any));
  },
...
export const Timer_Configuration_TimerTypeCountdownToTime: MessageFns<Timer_Configuration_TimerTypeCountdownToTime> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Timer_Configuration_TimerTypeCountdownToTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Timer_Configuration_TimerTypeCountdownToTime>, I>>(
    base?: I,
  ): Timer_Configuration_TimerTypeCountdownToTime {
    return Timer_Configuration_TimerTypeCountdownToTime.fromPartial(base ?? ({} as any));
  },
...
export const Timer_Configuration_TimerTypeElapsedTime: MessageFns<Timer_Configuration_TimerTypeElapsedTime> = {
  encode(message: Timer_Configuration_TimerTypeElapsedTime, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Timer_Configuration_TimerTypeElapsedTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Timer_Configuration_TimerTypeElapsedTime {
    return {
      ...
      hasEndTime: isSet(object.hasEndTime) ? globalThis.Boolean(object.hasEndTime) : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Timer_Configuration_TimerTypeElapsedTime>, I>>(
    base?: I,
  ): Timer_Configuration_TimerTypeElapsedTime {
    return Timer_Configuration_TimerTypeElapsedTime.fromPartial(base ?? ({} as any));
  },
...
export const TimersDocument: MessageFns<TimersDocument> = {
  encode(message: TimersDocument, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.clock !== undefined) {
      Clock.encode(message.clock, writer.uint32(18).fork()).join();
    }
    for (const v of message.timers) {
      Timer.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TimersDocument {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TimersDocument {
    return {
      ...
      timers: globalThis.Array.isArray(object?.timers) ? object.timers.map((e: any) => Timer.fromJSON(e)) : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<TimersDocument>, I>>(base?: I): TimersDocument {
