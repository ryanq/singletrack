...
export const Message: MessageFns<Message> = {
  encode(message: Message, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.template !== undefined) {
      TemplateIdentification.encode(message.template, writer.uint32(50).fork()).join();
    }
    ...
    for (const v of message.tokens) {
      Message_Token.encode(v!, writer.uint32(90).fork()).join();
    }
    for (const v of message.tokenValues) {
      Message_TokenValue.encode(v!, writer.uint32(98).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Message {
    return {
      ...
      timeToRemove: isSet(object.timeToRemove) ? globalThis.Number(object.timeToRemove) : 0,
      visibleOnNetwork: isSet(object.visibleOnNetwork) ? globalThis.Boolean(object.visibleOnNetwork) : false,
      ...
      tokens: globalThis.Array.isArray(object?.tokens) ? object.tokens.map((e: any) => Message_Token.fromJSON(e)) : [],
  ...
  toJSON(message: Message): unknown {
    ...
    if (message.tokenValues?.length) {
      obj.tokenValues = message.tokenValues.map((e) => Message_TokenValue.toJSON(e));
    }
    return obj;
  },
...
export const Message_Token: MessageFns<Message_Token> = {
  encode(message: Message_Token, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.text !== undefined) {
      Message_Token_TokenTypeText.encode(message.text, writer.uint32(18).fork()).join();
    }
    if (message.timer !== undefined) {
      Message_Token_TokenTypeTimer.encode(message.timer, writer.uint32(26).fork()).join();
    }
    if (message.clock !== undefined) {
      Message_Token_TokenTypeClock.encode(message.clock, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Message_Token {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Message_Token_TokenTypeText: MessageFns<Message_Token_TokenTypeText> = {
  encode(message: Message_Token_TokenTypeText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Message_Token_TokenTypeText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Message_Token_TokenTypeTimer: MessageFns<Message_Token_TokenTypeTimer> = {
  encode(message: Message_Token_TokenTypeTimer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.timerUuid !== undefined) {
      UUID.encode(message.timerUuid, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Message_Token_TokenTypeTimer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Message_Token_TokenTypeClock: MessageFns<Message_Token_TokenTypeClock> = {
  encode(_: Message_Token_TokenTypeClock, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Message_Token_TokenTypeClock {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Message_TokenValue: MessageFns<Message_TokenValue> = {
  encode(message: Message_TokenValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tokenId !== undefined) {
      UUID.encode(message.tokenId, writer.uint32(10).fork()).join();
    }
    if (message.tokenName !== "") {
      writer.uint32(42).string(message.tokenName);
    }
    if (message.text !== undefined) {
      Message_TokenValue_TokenValueText.encode(message.text, writer.uint32(18).fork()).join();
    }
    if (message.timer !== undefined) {
      Message_TokenValue_TokenValueTimer.encode(message.timer, writer.uint32(26).fork()).join();
    }
    if (message.clock !== undefined) {
      Message_TokenValue_TokenValueClock.encode(message.clock, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Message_TokenValue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Message_TokenValue_TokenValueText: MessageFns<Message_TokenValue_TokenValueText> = {
  encode(message: Message_TokenValue_TokenValueText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Message_TokenValue_TokenValueText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Message_TokenValue_TokenValueTimer: MessageFns<Message_TokenValue_TokenValueTimer> = {
  encode(message: Message_TokenValue_TokenValueTimer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.configuration !== undefined) {
      Timer_Configuration.encode(message.configuration, writer.uint32(10).fork()).join();
    }
    if (message.format !== undefined) {
      Timer_Format.encode(message.format, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Message_TokenValue_TokenValueTimer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Message_TokenValue_TokenValueClock: MessageFns<Message_TokenValue_TokenValueClock> = {
  encode(message: Message_TokenValue_TokenValueClock, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.format !== undefined) {
      Clock_Format.encode(message.format, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Message_TokenValue_TokenValueClock {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MessageDocument: MessageFns<MessageDocument> = {
  encode(message: MessageDocument, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MessageDocument {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
