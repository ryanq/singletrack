...
export function graphics_Text_Attributes_AlignmentFromJSON(object: any): Graphics_Text_Attributes_Alignment {
  switch (object) {
    case 0:
    case "ALIGNMENT_LEFT":
...
export function graphics_Text_Attributes_AlignmentToJSON(object: Graphics_Text_Attributes_Alignment): string {
  switch (object) {
...
export function media_ScaleAlignmentFromJSON(object: any): Media_ScaleAlignment {
  switch (object) {
    case 0:
...
export function media_ScaleAlignmentToJSON(object: Media_ScaleAlignment): string {
  switch (object) {
...
export const Graphics: MessageFns<Graphics> = {
  encode(_: Graphics, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics {
...
export const Graphics_Element: MessageFns<Graphics_Element> = {
  encode(message: Graphics_Element, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bounds !== undefined) {
      Graphics_Rect.encode(message.bounds, writer.uint32(26).fork()).join();
    }
    ...
    if (message.path !== undefined) {
      Graphics_Path.encode(message.path, writer.uint32(66).fork()).join();
    }
    if (message.fill !== undefined) {
      Graphics_Fill.encode(message.fill, writer.uint32(74).fork()).join();
    }
    if (message.stroke !== undefined) {
      Graphics_Stroke.encode(message.stroke, writer.uint32(82).fork()).join();
    }
    if (message.shadow !== undefined) {
      Graphics_Shadow.encode(message.shadow, writer.uint32(90).fork()).join();
    }
    if (message.feather !== undefined) {
      Graphics_Feather.encode(message.feather, writer.uint32(98).fork()).join();
    }
    if (message.text !== undefined) {
      Graphics_Text.encode(message.text, writer.uint32(106).fork()).join();
    }
    ...
    if (message.textLineMask !== undefined) {
      Graphics_Text_LineFillMask.encode(message.textLineMask, writer.uint32(114).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Element {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Element {
    return {
      ...
      aspectRatioLocked: isSet(object.aspectRatioLocked) ? globalThis.Boolean(object.aspectRatioLocked) : false,
  ...
  toJSON(message: Graphics_Element): unknown {
    ...
    if (message.textLineMask !== undefined) {
      obj.textLineMask = Graphics_Text_LineFillMask.toJSON(message.textLineMask);
    }
    return obj;
  },
...
export const Graphics_Rect: MessageFns<Graphics_Rect> = {
  encode(message: Graphics_Rect, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.origin !== undefined) {
      Graphics_Point.encode(message.origin, writer.uint32(10).fork()).join();
    }
    if (message.size !== undefined) {
      Graphics_Size.encode(message.size, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Rect {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Point: MessageFns<Graphics_Point> = {
  encode(message: Graphics_Point, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.x !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Point {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Size: MessageFns<Graphics_Size> = {
  encode(message: Graphics_Size, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.width !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Size {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_EdgeInsets: MessageFns<Graphics_EdgeInsets> = {
  encode(message: Graphics_EdgeInsets, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.left !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_EdgeInsets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Path: MessageFns<Graphics_Path> = {
  encode(message: Graphics_Path, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.closed !== false) {
      writer.uint32(8).bool(message.closed);
    }
    for (const v of message.points) {
      Graphics_Path_BezierPoint.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.shape !== undefined) {
      Graphics_Path_Shape.encode(message.shape, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Path {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Graphics_Path): unknown {
    ...
    if (message.points?.length) {
      obj.points = message.points.map((e) => Graphics_Path_BezierPoint.toJSON(e));
    }
    if (message.shape !== undefined) {
...
export const Graphics_Path_BezierPoint: MessageFns<Graphics_Path_BezierPoint> = {
  encode(message: Graphics_Path_BezierPoint, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.point !== undefined) {
      Graphics_Point.encode(message.point, writer.uint32(10).fork()).join();
    }
    if (message.q0 !== undefined) {
      Graphics_Point.encode(message.q0, writer.uint32(18).fork()).join();
    }
    if (message.q1 !== undefined) {
      Graphics_Point.encode(message.q1, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Path_BezierPoint {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Path_Shape: MessageFns<Graphics_Path_Shape> = {
  encode(message: Graphics_Path_Shape, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type);
    }
    if (message.roundedRectangle !== undefined) {
      Graphics_Path_Shape_RoundedRectangle.encode(message.roundedRectangle, writer.uint32(18).fork()).join();
    }
    if (message.polygon !== undefined) {
      Graphics_Path_Shape_Polygon.encode(message.polygon, writer.uint32(26).fork()).join();
    }
    if (message.star !== undefined) {
      Graphics_Path_Shape_Star.encode(message.star, writer.uint32(34).fork()).join();
    }
    if (message.arrow !== undefined) {
      Graphics_Path_Shape_Arrow.encode(message.arrow, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Path_Shape {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Graphics_Path_Shape): unknown {
    ...
    if (message.roundedRectangle !== undefined) {
      obj.roundedRectangle = Graphics_Path_Shape_RoundedRectangle.toJSON(message.roundedRectangle);
    }
    if (message.polygon !== undefined) {
...
export const Graphics_Path_Shape_RoundedRectangle: MessageFns<Graphics_Path_Shape_RoundedRectangle> = {
  encode(message: Graphics_Path_Shape_RoundedRectangle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Path_Shape_RoundedRectangle {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Path_Shape_RoundedRectangle {
    return { roundness: isSet(object.roundness) ? globalThis.Number(object.roundness) : 0 };
  },
  ...
  create<I extends Exact<DeepPartial<Graphics_Path_Shape_RoundedRectangle>, I>>(
    ...
    return Graphics_Path_Shape_RoundedRectangle.fromPartial(base ?? ({} as any));
  },
...
export const Graphics_Path_Shape_Arrow: MessageFns<Graphics_Path_Shape_Arrow> = {
  encode(message: Graphics_Path_Shape_Arrow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.corner !== undefined) {
      Graphics_Point.encode(message.corner, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Path_Shape_Arrow {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Path_Shape_Polygon: MessageFns<Graphics_Path_Shape_Polygon> = {
  encode(message: Graphics_Path_Shape_Polygon, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Path_Shape_Polygon {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Path_Shape_Polygon {
    return { numberSides: isSet(object.numberSides) ? globalThis.Number(object.numberSides) : 0 };
  },
...
export const Graphics_Path_Shape_Star: MessageFns<Graphics_Path_Shape_Star> = {
  encode(message: Graphics_Path_Shape_Star, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Path_Shape_Star {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Path_Shape_Star {
    return {
      innerRadius: isSet(object.innerRadius) ? globalThis.Number(object.innerRadius) : 0,
      numberPoints: isSet(object.numberPoints) ? globalThis.Number(object.numberPoints) : 0,
    };
  },
...
export const Graphics_Fill: MessageFns<Graphics_Fill> = {
  encode(message: Graphics_Fill, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.backgroundEffect !== undefined) {
      Graphics_BackgroundEffect.encode(message.backgroundEffect, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Fill {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_BackgroundEffect: MessageFns<Graphics_BackgroundEffect> = {
  encode(message: Graphics_BackgroundEffect, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.backgroundBlur !== undefined) {
      Graphics_BackgroundEffect_BackgroundEffectBlur.encode(message.backgroundBlur, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_BackgroundEffect {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Graphics_BackgroundEffect): unknown {
    const obj: any = {};
    if (message.backgroundBlur !== undefined) {
      obj.backgroundBlur = Graphics_BackgroundEffect_BackgroundEffectBlur.toJSON(message.backgroundBlur);
    }
    if (message.backgroundInvert !== undefined) {
      obj.backgroundInvert = Graphics_BackgroundEffect_BackgroundEffectInvert.toJSON(message.backgroundInvert);
    }
    return obj;
  },
...
export const Graphics_BackgroundEffect_BackgroundEffectBlur: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_BackgroundEffect_BackgroundEffectBlur {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_BackgroundEffect_BackgroundEffectBlur {
    return {
      ...
      blurAmount: isSet(object.blurAmount) ? globalThis.Number(object.blurAmount) : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Graphics_BackgroundEffect_BackgroundEffectBlur>, I>>(
    ...
    return Graphics_BackgroundEffect_BackgroundEffectBlur.fromPartial(base ?? ({} as any));
  },
...
export const Graphics_BackgroundEffect_BackgroundEffectInvert: MessageFns<
  Graphics_BackgroundEffect_BackgroundEffectInvert
> = {
  encode(_: Graphics_BackgroundEffect_BackgroundEffectInvert, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_BackgroundEffect_BackgroundEffectInvert {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Graphics_BackgroundEffect_BackgroundEffectInvert>, I>>(
    ...
    return Graphics_BackgroundEffect_BackgroundEffectInvert.fromPartial(base ?? ({} as any));
  },
...
export const Graphics_Gradient: MessageFns<Graphics_Gradient> = {
  encode(message: Graphics_Gradient, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type);
    }
    if (message.angle !== 0) {
    ...
    for (const v of message.stops) {
      Graphics_Gradient_ColorStop.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Gradient {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Graphics_Gradient): unknown {
    ...
    if (message.stops?.length) {
      obj.stops = message.stops.map((e) => Graphics_Gradient_ColorStop.toJSON(e));
    }
    return obj;
  },
...
export const Graphics_Gradient_ColorStop: MessageFns<Graphics_Gradient_ColorStop> = {
  encode(message: Graphics_Gradient_ColorStop, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.color !== undefined) {
      Color.encode(message.color, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Gradient_ColorStop {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Gradient_ColorStop {
    return {
      ...
      blendPoint: isSet(object.blendPoint) ? globalThis.Number(object.blendPoint) : 0,
    };
  },
...
export const Graphics_Shadow: MessageFns<Graphics_Shadow> = {
  encode(message: Graphics_Shadow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.style !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Shadow {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Stroke: MessageFns<Graphics_Stroke> = {
  encode(message: Graphics_Stroke, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.style !== 0) {
      writer.uint32(8).int32(message.style);
    }
    if (message.width !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Stroke {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Stroke {
    return {
      ...
      width: isSet(object.width) ? globalThis.Number(object.width) : 0,
      color: isSet(object.color) ? Color.fromJSON(object.color) : undefined,
      pattern: globalThis.Array.isArray(object?.pattern) ? object.pattern.map((e: any) => globalThis.Number(e)) : [],
      enable: isSet(object.enable) ? globalThis.Boolean(object.enable) : false,
    };
  },
...
export const Graphics_Feather: MessageFns<Graphics_Feather> = {
  encode(message: Graphics_Feather, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.style !== 0) {
      writer.uint32(8).int32(message.style);
    }
    if (message.radius !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Feather {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Text: MessageFns<Graphics_Text> = {
  encode(message: Graphics_Text, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.attributes !== undefined) {
      Graphics_Text_Attributes.encode(message.attributes, writer.uint32(26).fork()).join();
    }
    if (message.shadow !== undefined) {
      Graphics_Shadow.encode(message.shadow, writer.uint32(34).fork()).join();
    }
    ...
    if (message.margins !== undefined) {
      Graphics_EdgeInsets.encode(message.margins, writer.uint32(66).fork()).join();
    }
    ...
    if (message.chordPro !== undefined) {
      Graphics_Text_ChordPro.encode(message.chordPro, writer.uint32(98).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Text {
    return {
      ...
      shadow: isSet(object.shadow) ? Graphics_Shadow.fromJSON(object.shadow) : undefined,
      rtfData: isSet(object.rtfData) ? bytesFromBase64(object.rtfData) : new Uint8Array(0),
      ...
      transformDelimiter: isSet(object.transformDelimiter) ? globalThis.String(object.transformDelimiter) : "",
...
export const Graphics_Text_LineFillMask: MessageFns<Graphics_Text_LineFillMask> = {
  encode(message: Graphics_Text_LineFillMask, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_LineFillMask {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Text_LineFillMask {
    return {
      ...
      heightOffset: isSet(object.heightOffset) ? globalThis.Number(object.heightOffset) : 0,
      verticalOffset: isSet(object.verticalOffset) ? globalThis.Number(object.verticalOffset) : 0,
      maskStyle: isSet(object.maskStyle) ? graphics_Text_LineFillMask_LineMaskStyleFromJSON(object.maskStyle) : 0,
      widthOffset: isSet(object.widthOffset) ? globalThis.Number(object.widthOffset) : 0,
      horizontalOffset: isSet(object.horizontalOffset) ? globalThis.Number(object.horizontalOffset) : 0,
    };
  },
...
export const Graphics_Text_GradientFill: MessageFns<Graphics_Text_GradientFill> = {
  encode(message: Graphics_Text_GradientFill, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.gradient !== undefined) {
      Graphics_Gradient.encode(message.gradient, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_GradientFill {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Text_CutOutFill: MessageFns<Graphics_Text_CutOutFill> = {
  encode(_: Graphics_Text_CutOutFill, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_CutOutFill {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Text_MediaFill: MessageFns<Graphics_Text_MediaFill> = {
  encode(message: Graphics_Text_MediaFill, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.media !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_MediaFill {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Text_ChordPro: MessageFns<Graphics_Text_ChordPro> = {
  encode(message: Graphics_Text_ChordPro, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.enabled !== false) {
      writer.uint32(8).bool(message.enabled);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_ChordPro {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Graphics_Text_Attributes: MessageFns<Graphics_Text_Attributes> = {
  encode(message: Graphics_Text_Attributes, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.font !== undefined) {
      Font.encode(message.font, writer.uint32(10).fork()).join();
    }
    if (message.capitalization !== 0) {
      writer.uint32(16).int32(message.capitalization);
    }
    if (message.underlineStyle !== undefined) {
      Graphics_Text_Attributes_Underline.encode(message.underlineStyle, writer.uint32(34).fork()).join();
    }
    if (message.underlineColor !== undefined) {
      Color.encode(message.underlineColor, writer.uint32(42).fork()).join();
    }
    if (message.paragraphStyle !== undefined) {
      Graphics_Text_Attributes_Paragraph.encode(message.paragraphStyle, writer.uint32(50).fork()).join();
    }
    ...
    if (message.strikethroughStyle !== undefined) {
      Graphics_Text_Attributes_Underline.encode(message.strikethroughStyle, writer.uint32(74).fork()).join();
    }
    if (message.strikethroughColor !== undefined) {
      Color.encode(message.strikethroughColor, writer.uint32(82).fork()).join();
    }
    if (message.strokeWidth !== 0) {
      writer.uint32(89).double(message.strokeWidth);
    }
    if (message.strokeColor !== undefined) {
      Color.encode(message.strokeColor, writer.uint32(98).fork()).join();
    }
    for (const v of message.customAttributes) {
      Graphics_Text_Attributes_CustomAttribute.encode(v!, writer.uint32(106).fork()).join();
    }
    if (message.backgroundColor !== undefined) {
      Color.encode(message.backgroundColor, writer.uint32(122).fork()).join();
    }
    if (message.textSolidFill !== undefined) {
      Color.encode(message.textSolidFill, writer.uint32(26).fork()).join();
    }
    if (message.textGradientFill !== undefined) {
      Graphics_Text_GradientFill.encode(message.textGradientFill, writer.uint32(114).fork()).join();
    }
    if (message.cutOutFill !== undefined) {
      Graphics_Text_CutOutFill.encode(message.cutOutFill, writer.uint32(130).fork()).join();
    }
    if (message.mediaFill !== undefined) {
      Graphics_Text_MediaFill.encode(message.mediaFill, writer.uint32(138).fork()).join();
    }
    if (message.backgroundEffect !== undefined) {
      Graphics_BackgroundEffect.encode(message.backgroundEffect, writer.uint32(146).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_Attributes {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Text_Attributes {
    return {
      ...
      superscript: isSet(object.superscript) ? globalThis.Number(object.superscript) : 0,
  ...
  toJSON(message: Graphics_Text_Attributes): unknown {
    ...
    if (message.underlineStyle !== undefined) {
      obj.underlineStyle = Graphics_Text_Attributes_Underline.toJSON(message.underlineStyle);
    }
    if (message.underlineColor !== undefined) {
      obj.underlineColor = Color.toJSON(message.underlineColor);
    }
    if (message.paragraphStyle !== undefined) {
      obj.paragraphStyle = Graphics_Text_Attributes_Paragraph.toJSON(message.paragraphStyle);
    }
    if (message.kerning !== 0) {
    ...
    if (message.strikethroughStyle !== undefined) {
      obj.strikethroughStyle = Graphics_Text_Attributes_Underline.toJSON(message.strikethroughStyle);
    }
    if (message.strikethroughColor !== undefined) {
    ...
    if (message.customAttributes?.length) {
      obj.customAttributes = message.customAttributes.map((e) => Graphics_Text_Attributes_CustomAttribute.toJSON(e));
    }
    if (message.backgroundColor !== undefined) {
    ...
    if (message.textGradientFill !== undefined) {
      obj.textGradientFill = Graphics_Text_GradientFill.toJSON(message.textGradientFill);
    }
    if (message.cutOutFill !== undefined) {
...
export const Graphics_Text_Attributes_Underline: MessageFns<Graphics_Text_Attributes_Underline> = {
  encode(message: Graphics_Text_Attributes_Underline, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.style !== 0) {
      writer.uint32(8).int32(message.style);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_Attributes_Underline {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Graphics_Text_Attributes_Underline): unknown {
    ...
    if (message.pattern !== 0) {
      obj.pattern = graphics_Text_Attributes_Underline_PatternToJSON(message.pattern);
    }
    if (message.byWord !== false) {
...
export const Graphics_Text_Attributes_Paragraph: MessageFns<Graphics_Text_Attributes_Paragraph> = {
  encode(message: Graphics_Text_Attributes_Paragraph, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.tabStops) {
      Graphics_Text_Attributes_Paragraph_TabStop.encode(v!, writer.uint32(90).fork()).join();
    }
    if (message.defaultTabInterval !== 0) {
      writer.uint32(97).double(message.defaultTabInterval);
    }
    if (message.textList !== undefined) {
      Graphics_Text_Attributes_Paragraph_TextList.encode(message.textList, writer.uint32(106).fork()).join();
    }
    for (const v of message.textLists) {
      Graphics_Text_Attributes_Paragraph_TextList.encode(v!, writer.uint32(114).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_Attributes_Paragraph {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Text_Attributes_Paragraph {
    return {
      alignment: isSet(object.alignment) ? graphics_Text_Attributes_AlignmentFromJSON(object.alignment) : 0,
      firstLineHeadIndent: isSet(object.firstLineHeadIndent) ? globalThis.Number(object.firstLineHeadIndent) : 0,
      headIndent: isSet(object.headIndent) ? globalThis.Number(object.headIndent) : 0,
      tailIndent: isSet(object.tailIndent) ? globalThis.Number(object.tailIndent) : 0,
      lineHeightMultiple: isSet(object.lineHeightMultiple) ? globalThis.Number(object.lineHeightMultiple) : 0,
      maximumLineHeight: isSet(object.maximumLineHeight) ? globalThis.Number(object.maximumLineHeight) : 0,
      minimumLineHeight: isSet(object.minimumLineHeight) ? globalThis.Number(object.minimumLineHeight) : 0,
      lineSpacing: isSet(object.lineSpacing) ? globalThis.Number(object.lineSpacing) : 0,
      paragraphSpacing: isSet(object.paragraphSpacing) ? globalThis.Number(object.paragraphSpacing) : 0,
      ...
      tabStops: globalThis.Array.isArray(object?.tabStops)
        ...
        : [],
      defaultTabInterval: isSet(object.defaultTabInterval) ? globalThis.Number(object.defaultTabInterval) : 0,
  ...
  toJSON(message: Graphics_Text_Attributes_Paragraph): unknown {
    const obj: any = {};
    if (message.alignment !== 0) {
      obj.alignment = graphics_Text_Attributes_AlignmentToJSON(message.alignment);
    }
    if (message.firstLineHeadIndent !== 0) {
    ...
    if (message.tabStops?.length) {
      obj.tabStops = message.tabStops.map((e) => Graphics_Text_Attributes_Paragraph_TabStop.toJSON(e));
    }
    if (message.defaultTabInterval !== 0) {
      obj.defaultTabInterval = message.defaultTabInterval;
    }
    if (message.textList !== undefined) {
      obj.textList = Graphics_Text_Attributes_Paragraph_TextList.toJSON(message.textList);
    }
    if (message.textLists?.length) {
      obj.textLists = message.textLists.map((e) => Graphics_Text_Attributes_Paragraph_TextList.toJSON(e));
    }
    return obj;
  },
...
export const Graphics_Text_Attributes_Paragraph_TabStop: MessageFns<Graphics_Text_Attributes_Paragraph_TabStop> = {
  encode(message: Graphics_Text_Attributes_Paragraph_TabStop, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_Attributes_Paragraph_TabStop {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Graphics_Text_Attributes_Paragraph_TabStop>, I>>(
    ...
    return Graphics_Text_Attributes_Paragraph_TabStop.fromPartial(base ?? ({} as any));
  },
...
export const Graphics_Text_Attributes_Paragraph_TextList: MessageFns<Graphics_Text_Attributes_Paragraph_TextList> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_Attributes_Paragraph_TextList {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Text_Attributes_Paragraph_TextList {
    return {
      ...
      startingNumber: isSet(object.startingNumber) ? globalThis.Number(object.startingNumber) : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Graphics_Text_Attributes_Paragraph_TextList>, I>>(
    ...
    return Graphics_Text_Attributes_Paragraph_TextList.fromPartial(base ?? ({} as any));
  },
...
export const Graphics_Text_Attributes_CustomAttribute: MessageFns<Graphics_Text_Attributes_CustomAttribute> = {
  encode(message: Graphics_Text_Attributes_CustomAttribute, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.textGradientFill !== undefined) {
      Graphics_Text_GradientFill.encode(message.textGradientFill, writer.uint32(42).fork()).join();
    }
    ...
    if (message.cutOutFill !== undefined) {
      Graphics_Text_CutOutFill.encode(message.cutOutFill, writer.uint32(66).fork()).join();
    }
    if (message.mediaFill !== undefined) {
      Graphics_Text_MediaFill.encode(message.mediaFill, writer.uint32(74).fork()).join();
    }
    if (message.backgroundEffect !== undefined) {
      Graphics_BackgroundEffect.encode(message.backgroundEffect, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Graphics_Text_Attributes_CustomAttribute {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Graphics_Text_Attributes_CustomAttribute {
    return {
      ...
      capitalization: isSet(object.capitalization)
        ? graphics_Text_Attributes_CapitalizationFromJSON(object.capitalization)
        : undefined,
      originalFontSize: isSet(object.originalFontSize) ? globalThis.Number(object.originalFontSize) : undefined,
      fontScaleFactor: isSet(object.fontScaleFactor) ? globalThis.Number(object.fontScaleFactor) : undefined,
      textGradientFill: isSet(object.textGradientFill)
        ? Graphics_Text_GradientFill.fromJSON(object.textGradientFill)
        : undefined,
  ...
  create<I extends Exact<DeepPartial<Graphics_Text_Attributes_CustomAttribute>, I>>(
    ...
    return Graphics_Text_Attributes_CustomAttribute.fromPartial(base ?? ({} as any));
  },
...
export const Media: MessageFns<Media> = {
  encode(message: Media, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.url !== undefined) {
      URL.encode(message.url, writer.uint32(18).fork()).join();
    }
    if (message.metadata !== undefined) {
      Media_Metadata.encode(message.metadata, writer.uint32(26).fork()).join();
    }
    if (message.audio !== undefined) {
      Media_AudioTypeProperties.encode(message.audio, writer.uint32(34).fork()).join();
    }
    if (message.image !== undefined) {
      Media_ImageTypeProperties.encode(message.image, writer.uint32(42).fork()).join();
    }
    if (message.video !== undefined) {
      Media_VideoTypeProperties.encode(message.video, writer.uint32(50).fork()).join();
    }
    if (message.liveVideo !== undefined) {
      Media_LiveVideoTypeProperties.encode(message.liveVideo, writer.uint32(58).fork()).join();
    }
    if (message.webContent !== undefined) {
      Media_WebContentTypeProperties.encode(message.webContent, writer.uint32(66).fork()).join();
    }
    return writer;
  },
  ...
  toJSON(message: Media): unknown {
    ...
    if (message.webContent !== undefined) {
      obj.webContent = Media_WebContentTypeProperties.toJSON(message.webContent);
    }
    return obj;
  },
...
export const Media_Metadata: MessageFns<Media_Metadata> = {
  encode(message: Media_Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.manufactureName !== "") {
      writer.uint32(10).string(message.manufactureName);
    }
    if (message.manufactureUrl !== undefined) {
      URL.encode(message.manufactureUrl, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_Metadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_Metadata {
    return {
      manufactureName: isSet(object.manufactureName) ? globalThis.String(object.manufactureName) : "",
      manufactureUrl: isSet(object.manufactureUrl) ? URL.fromJSON(object.manufactureUrl) : undefined,
      information: isSet(object.information) ? globalThis.String(object.information) : "",
...
export const Media_VideoDevice: MessageFns<Media_VideoDevice> = {
  encode(message: Media_VideoDevice, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type);
    }
    if (message.name !== "") {
    ...
    if (message.audioRouting !== undefined) {
      DigitalAudio_Device_Routing.encode(message.audioRouting, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Media_VideoDevice {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_VideoDevice {
    return {
      ...
      formatIndex: isSet(object.formatIndex) ? globalThis.Number(object.formatIndex) : 0,
  ...
  toJSON(message: Media_VideoDevice): unknown {
    ...
    if (message.audioRouting !== undefined) {
      obj.audioRouting = DigitalAudio_Device_Routing.toJSON(message.audioRouting);
    }
    return obj;
  },
...
export const Media_AudioDevice: MessageFns<Media_AudioDevice> = {
  encode(message: Media_AudioDevice, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_AudioDevice {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Media_Audio: MessageFns<Media_Audio> = {
  encode(_: Media_Audio, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Media_Audio {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Media_Audio_Channel: MessageFns<Media_Audio_Channel> = {
  encode(message: Media_Audio_Channel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.index !== 0) {
    ...
    for (const v of message.outputs) {
      Media_Audio_Channel_Output.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Media_Audio_Channel {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_Audio_Channel {
    return {
      ...
      compressLimit: isSet(object.compressLimit) ? globalThis.Boolean(object.compressLimit) : false,
  ...
  toJSON(message: Media_Audio_Channel): unknown {
    ...
    if (message.outputs?.length) {
      obj.outputs = message.outputs.map((e) => Media_Audio_Channel_Output.toJSON(e));
    }
    return obj;
  },
...
export const Media_Audio_Channel_Output: MessageFns<Media_Audio_Channel_Output> = {
  encode(message: Media_Audio_Channel_Output, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_Audio_Channel_Output {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_Audio_Channel_Output {
    return { channelIndex: isSet(object.channelIndex) ? globalThis.Number(object.channelIndex) : 0 };
  },
...
export const Media_AudioProperties: MessageFns<Media_AudioProperties> = {
  encode(message: Media_AudioProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.volume !== 0) {
      writer.uint32(9).double(message.volume);
    }
    for (const v of message.audioChannels) {
      Media_Audio_Channel.encode(v!, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_AudioProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_AudioProperties {
    return {
      ...
      audioChannels: globalThis.Array.isArray(object?.audioChannels)
        ...
        : [],
      isCustomMapping: isSet(object.isCustomMapping) ? globalThis.Boolean(object.isCustomMapping) : false,
    };
  },
  ...
  toJSON(message: Media_AudioProperties): unknown {
    ...
    if (message.audioChannels?.length) {
      obj.audioChannels = message.audioChannels.map((e) => Media_Audio_Channel.toJSON(e));
    }
    if (message.isCustomMapping !== false) {
...
export const Media_TransportProperties: MessageFns<Media_TransportProperties> = {
  encode(message: Media_TransportProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_TransportProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_TransportProperties {
    return {
      ...
      fadeInDuration: isSet(object.fadeInDuration) ? globalThis.Number(object.fadeInDuration) : 0,
      fadeOutDuration: isSet(object.fadeOutDuration) ? globalThis.Number(object.fadeOutDuration) : 0,
      shouldFadeIn: isSet(object.shouldFadeIn) ? globalThis.Boolean(object.shouldFadeIn) : false,
      shouldFadeOut: isSet(object.shouldFadeOut) ? globalThis.Boolean(object.shouldFadeOut) : false,
      ...
      timesToLoop: isSet(object.timesToLoop) ? globalThis.Number(object.timesToLoop) : 0,
      retrigger: isSet(object.retrigger) ? media_TransportProperties_RetriggerSettingFromJSON(object.retrigger) : 0,
    };
  },
  ...
  toJSON(message: Media_TransportProperties): unknown {
    ...
    if (message.retrigger !== 0) {
      obj.retrigger = media_TransportProperties_RetriggerSettingToJSON(message.retrigger);
    }
    return obj;
  },
...
export const Media_DrawingProperties: MessageFns<Media_DrawingProperties> = {
  encode(message: Media_DrawingProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.scaleBehavior !== 0) {
    ...
    if (message.naturalSize !== undefined) {
      Graphics_Size.encode(message.naturalSize, writer.uint32(42).fork()).join();
    }
    ...
    if (message.customImageBounds !== undefined) {
      Graphics_Rect.encode(message.customImageBounds, writer.uint32(58).fork()).join();
    }
    ...
    if (message.selectedEffectPresetUuid !== undefined) {
      UUID.encode(message.selectedEffectPresetUuid, writer.uint32(90).fork()).join();
    }
    for (const v of message.effects) {
      Effect.encode(v!, writer.uint32(98).fork()).join();
    }
    if (message.cropEnable !== false) {
      writer.uint32(104).bool(message.cropEnable);
    }
    if (message.cropInsets !== undefined) {
      Graphics_EdgeInsets.encode(message.cropInsets, writer.uint32(114).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_DrawingProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_DrawingProperties {
    return {
      scaleBehavior: isSet(object.scaleBehavior) ? media_ScaleBehaviorFromJSON(object.scaleBehavior) : 0,
      isBlurred: isSet(object.isBlurred) ? globalThis.Boolean(object.isBlurred) : false,
      scaleAlignment: isSet(object.scaleAlignment) ? media_ScaleAlignmentFromJSON(object.scaleAlignment) : 0,
      flippedHorizontally: isSet(object.flippedHorizontally) ? globalThis.Boolean(object.flippedHorizontally) : false,
      flippedVertically: isSet(object.flippedVertically) ? globalThis.Boolean(object.flippedVertically) : false,
      naturalSize: isSet(object.naturalSize) ? Graphics_Size.fromJSON(object.naturalSize) : undefined,
      customImageRotation: isSet(object.customImageRotation) ? globalThis.Number(object.customImageRotation) : 0,
      ...
      customImageAspectLocked: isSet(object.customImageAspectLocked)
        ...
        : false,
      alphaInverted: isSet(object.alphaInverted) ? globalThis.Boolean(object.alphaInverted) : false,
      ...
      cropEnable: isSet(object.cropEnable) ? globalThis.Boolean(object.cropEnable) : false,
      cropInsets: isSet(object.cropInsets) ? Graphics_EdgeInsets.fromJSON(object.cropInsets) : undefined,
      alphaType: isSet(object.alphaType) ? alphaTypeFromJSON(object.alphaType) : 0,
    };
  },
  ...
  toJSON(message: Media_DrawingProperties): unknown {
    ...
    if (message.selectedEffectPresetUuid !== undefined) {
      obj.selectedEffectPresetUuid = UUID.toJSON(message.selectedEffectPresetUuid);
    }
...
export const Media_VideoProperties: MessageFns<Media_VideoProperties> = {
  encode(message: Media_VideoProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_VideoProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_VideoProperties {
    return {
      ...
      thumbnailPosition: isSet(object.thumbnailPosition) ? globalThis.Number(object.thumbnailPosition) : 0,
      endBehavior: isSet(object.endBehavior) ? media_VideoProperties_EndBehaviorFromJSON(object.endBehavior) : 0,
      softLoop: isSet(object.softLoop) ? globalThis.Boolean(object.softLoop) : false,
      softLoopDuration: isSet(object.softLoopDuration) ? globalThis.Number(object.softLoopDuration) : 0,
    };
  },
...
export const Media_LiveVideoProperties: MessageFns<Media_LiveVideoProperties> = {
  encode(message: Media_LiveVideoProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.videoDevice !== undefined) {
      Media_VideoDevice.encode(message.videoDevice, writer.uint32(10).fork()).join();
    }
    if (message.audioDevice !== undefined) {
      Media_AudioDevice.encode(message.audioDevice, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_LiveVideoProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_LiveVideoProperties {
    return {
      ...
      liveVideoIndex: isSet(object.liveVideoIndex) ? globalThis.Number(object.liveVideoIndex) : 0,
    };
  },
...
export const Media_AudioTypeProperties: MessageFns<Media_AudioTypeProperties> = {
  encode(message: Media_AudioTypeProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.audio !== undefined) {
      Media_AudioProperties.encode(message.audio, writer.uint32(10).fork()).join();
    }
    if (message.transport !== undefined) {
      Media_TransportProperties.encode(message.transport, writer.uint32(18).fork()).join();
    }
    if (message.file !== undefined) {
      FileProperties.encode(message.file, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Media_AudioTypeProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Media_AudioTypeProperties {
    return {
      ...
      file: isSet(object.file) ? FileProperties.fromJSON(object.file) : undefined,
    };
  },
...
export const Media_ImageTypeProperties: MessageFns<Media_ImageTypeProperties> = {
  encode(message: Media_ImageTypeProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.drawing !== undefined) {
      Media_DrawingProperties.encode(message.drawing, writer.uint32(10).fork()).join();
    }
    if (message.file !== undefined) {
      FileProperties.encode(message.file, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Media_ImageTypeProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseMedia_VideoTypeProperties(): Media_VideoTypeProperties {
  return { drawing: undefined, audio: undefined, transport: undefined, video: undefined, file: undefined };
}

export const Media_VideoTypeProperties: MessageFns<Media_VideoTypeProperties> = {
  encode(message: Media_VideoTypeProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.drawing !== undefined) {
      Media_DrawingProperties.encode(message.drawing, writer.uint32(10).fork()).join();
    }
    if (message.audio !== undefined) {
      Media_AudioProperties.encode(message.audio, writer.uint32(18).fork()).join();
    }
    if (message.transport !== undefined) {
      Media_TransportProperties.encode(message.transport, writer.uint32(26).fork()).join();
    }
    if (message.video !== undefined) {
      Media_VideoProperties.encode(message.video, writer.uint32(34).fork()).join();
    }
    if (message.file !== undefined) {
      FileProperties.encode(message.file, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Media_VideoTypeProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Media_LiveVideoTypeProperties: MessageFns<Media_LiveVideoTypeProperties> = {
  encode(message: Media_LiveVideoTypeProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.drawing !== undefined) {
      Media_DrawingProperties.encode(message.drawing, writer.uint32(10).fork()).join();
    }
    if (message.audio !== undefined) {
    ...
    if (message.liveVideo !== undefined) {
      Media_LiveVideoProperties.encode(message.liveVideo, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Media_LiveVideoTypeProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Media_WebContentTypeProperties: MessageFns<Media_WebContentTypeProperties> = {
  encode(message: Media_WebContentTypeProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.drawing !== undefined) {
      Media_DrawingProperties.encode(message.drawing, writer.uint32(10).fork()).join();
    }
    if (message.url !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Media_WebContentTypeProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
