...
export const Presentation: MessageFns<Presentation> = {
  encode(message: Presentation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.applicationInfo !== undefined) {
      ApplicationInfo.encode(message.applicationInfo, writer.uint32(10).fork()).join();
    }
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(18).fork()).join();
    }
    if (message.name !== "") {
      writer.uint32(26).string(message.name);
    }
    if (message.lastDateUsed !== undefined) {
      Timestamp.encode(message.lastDateUsed, writer.uint32(34).fork()).join();
    }
    if (message.lastModifiedDate !== undefined) {
      Timestamp.encode(message.lastModifiedDate, writer.uint32(42).fork()).join();
    }
    if (message.category !== "") {
    ...
    if (message.background !== undefined) {
      Background.encode(message.background, writer.uint32(66).fork()).join();
    }
    if (message.chordChart !== undefined) {
      URL.encode(message.chordChart, writer.uint32(74).fork()).join();
    }
    if (message.selectedArrangement !== undefined) {
      UUID.encode(message.selectedArrangement, writer.uint32(82).fork()).join();
    }
    for (const v of message.arrangements) {
      Presentation_Arrangement.encode(v!, writer.uint32(90).fork()).join();
    }
    for (const v of message.cueGroups) {
      Presentation_CueGroup.encode(v!, writer.uint32(98).fork()).join();
    }
    for (const v of message.cues) {
      Cue.encode(v!, writer.uint32(106).fork()).join();
    }
    if (message.ccli !== undefined) {
      Presentation_CCLI.encode(message.ccli, writer.uint32(114).fork()).join();
    }
    if (message.bibleReference !== undefined) {
      Presentation_BibleReference.encode(message.bibleReference, writer.uint32(122).fork()).join();
    }
    if (message.timeline !== undefined) {
      Presentation_Timeline.encode(message.timeline, writer.uint32(138).fork()).join();
    }
    if (message.transition !== undefined) {
      Transition.encode(message.transition, writer.uint32(146).fork()).join();
    }
    ...
    if (message.multiTracksLicensing !== undefined) {
      Presentation_MultiTracksLicensing.encode(message.multiTracksLicensing, writer.uint32(170).fork()).join();
    }
    if (message.musicKey !== "") {
      writer.uint32(178).string(message.musicKey);
    }
    if (message.music !== undefined) {
      Presentation_Music.encode(message.music, writer.uint32(186).fork()).join();
    }
  ...
  fromJSON(object: any): Presentation {
    return {
      ...
      cueGroups: globalThis.Array.isArray(object?.cueGroups)
        ...
        : [],
      cues: globalThis.Array.isArray(object?.cues) ? object.cues.map((e: any) => Cue.fromJSON(e)) : [],
      ...
      multiTracksLicensing: isSet(object.multiTracksLicensing)
        ...
        : undefined,
      musicKey: isSet(object.musicKey) ? globalThis.String(object.musicKey) : "",
      music: isSet(object.music) ? Presentation_Music.fromJSON(object.music) : undefined,
      slideShowDuration: isSet(object.slideShowDuration) ? globalThis.Number(object.slideShowDuration) : undefined,
    };
  },
  ...
  toJSON(message: Presentation): unknown {
    ...
    if (message.arrangements?.length) {
      obj.arrangements = message.arrangements.map((e) => Presentation_Arrangement.toJSON(e));
    }
    if (message.cueGroups?.length) {
      obj.cueGroups = message.cueGroups.map((e) => Presentation_CueGroup.toJSON(e));
    }
    ...
    if (message.bibleReference !== undefined) {
      obj.bibleReference = Presentation_BibleReference.toJSON(message.bibleReference);
    }
    if (message.timeline !== undefined) {
    ...
    if (message.multiTracksLicensing !== undefined) {
      obj.multiTracksLicensing = Presentation_MultiTracksLicensing.toJSON(message.multiTracksLicensing);
    }
    if (message.musicKey !== "") {
...
export const Presentation_CCLI: MessageFns<Presentation_CCLI> = {
  encode(message: Presentation_CCLI, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.author !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_CCLI {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Presentation_CCLI {
    return {
      ...
      artistCredits: isSet(object.artistCredits) ? globalThis.String(object.artistCredits) : "",
      songTitle: isSet(object.songTitle) ? globalThis.String(object.songTitle) : "",
      publisher: isSet(object.publisher) ? globalThis.String(object.publisher) : "",
      copyrightYear: isSet(object.copyrightYear) ? globalThis.Number(object.copyrightYear) : 0,
      songNumber: isSet(object.songNumber) ? globalThis.Number(object.songNumber) : 0,
...
export const Presentation_BibleReference: MessageFns<Presentation_BibleReference> = {
  encode(message: Presentation_BibleReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.chapterRange !== undefined) {
      IntRange.encode(message.chapterRange, writer.uint32(26).fork()).join();
    }
    if (message.verseRange !== undefined) {
      IntRange.encode(message.verseRange, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_BibleReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Presentation_BibleReference {
    return {
      bookIndex: isSet(object.bookIndex) ? globalThis.Number(object.bookIndex) : 0,
      bookName: isSet(object.bookName) ? globalThis.String(object.bookName) : "",
      ...
      translationName: isSet(object.translationName) ? globalThis.String(object.translationName) : "",
...
export const Presentation_Timeline: MessageFns<Presentation_Timeline> = {
  encode(message: Presentation_Timeline, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.cues) {
      Presentation_Timeline_Cue.encode(v!, writer.uint32(10).fork()).join();
    }
    ...
    if (message.audioAction !== undefined) {
      Action.encode(message.audioAction, writer.uint32(66).fork()).join();
    }
    ...
    for (const v of message.cuesV2) {
      Presentation_Timeline_Cue.encode(v!, writer.uint32(90).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_Timeline {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Presentation_Timeline {
    return {
      ...
      timecodeEnable: isSet(object.timecodeEnable) ? globalThis.Boolean(object.timecodeEnable) : false,
      timecodeOffset: isSet(object.timecodeOffset) ? globalThis.Number(object.timecodeOffset) : 0,
  ...
  toJSON(message: Presentation_Timeline): unknown {
    ...
    if (message.cuesV2?.length) {
      obj.cuesV2 = message.cuesV2.map((e) => Presentation_Timeline_Cue.toJSON(e));
    }
    return obj;
  },
...
export const Presentation_Timeline_Cue: MessageFns<Presentation_Timeline_Cue> = {
  encode(message: Presentation_Timeline_Cue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cueId !== undefined) {
      UUID.encode(message.cueId, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_Timeline_Cue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Presentation_Timeline_Cue {
    return {
      triggerTime: isSet(object.triggerTime) ? globalThis.Number(object.triggerTime) : 0,
      name: isSet(object.name) ? globalThis.String(object.name) : "",
...
export const Presentation_Arrangement: MessageFns<Presentation_Arrangement> = {
  encode(message: Presentation_Arrangement, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_Arrangement {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Presentation_Arrangement): unknown {
    ...
    if (message.groupIdentifiers?.length) {
      obj.groupIdentifiers = message.groupIdentifiers.map((e) => UUID.toJSON(e));
    }
    return obj;
  },
...
export const Presentation_CueGroup: MessageFns<Presentation_CueGroup> = {
  encode(message: Presentation_CueGroup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_CueGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Presentation_MultiTracksLicensing: MessageFns<Presentation_MultiTracksLicensing> = {
  encode(message: Presentation_MultiTracksLicensing, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.expirationDate !== undefined) {
      Timestamp.encode(message.expirationDate, writer.uint32(26).fork()).join();
    }
    if (message.licenseExpiration !== undefined) {
      Timestamp.encode(message.licenseExpiration, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_MultiTracksLicensing {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.songIdentifier = longToNumber(reader.int64());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): Presentation_MultiTracksLicensing {
    return {
      songIdentifier: isSet(object.songIdentifier) ? globalThis.Number(object.songIdentifier) : 0,
...
export const Presentation_Music: MessageFns<Presentation_Music> = {
  encode(message: Presentation_Music, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.original !== undefined) {
      MusicKeyScale.encode(message.original, writer.uint32(26).fork()).join();
    }
    if (message.user !== undefined) {
      MusicKeyScale.encode(message.user, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Presentation_Music {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Presentation_Music {
    return {
      originalMusicKey: isSet(object.originalMusicKey) ? globalThis.String(object.originalMusicKey) : "",
      userMusicKey: isSet(object.userMusicKey) ? globalThis.String(object.userMusicKey) : "",
