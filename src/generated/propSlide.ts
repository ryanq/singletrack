...
export const PropSlide: MessageFns<PropSlide> = {
  encode(message: PropSlide, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PropSlide {
