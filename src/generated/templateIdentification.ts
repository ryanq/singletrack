...
export const TemplateIdentification: MessageFns<TemplateIdentification> = {
  encode(message: TemplateIdentification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.slideUuid !== undefined) {
      UUID.encode(message.slideUuid, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TemplateIdentification {
  ...
  fromJSON(object: any): TemplateIdentification {
    return {
      ...
      slideName: isSet(object.slideName) ? globalThis.String(object.slideName) : "",
      slideIndex: isSet(object.slideIndex) ? globalThis.Number(object.slideIndex) : 0,
    };
  },
