...
export const VideoInput: MessageFns<VideoInput> = {
  encode(message: VideoInput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.videoInputDevice !== undefined) {
      Media_VideoDevice.encode(message.videoInputDevice, writer.uint32(26).fork()).join();
    }
    if (message.displayColor !== undefined) {
      Color.encode(message.displayColor, writer.uint32(34).fork()).join();
    }
    if (message.thumbnailPath !== undefined) {
      URL.encode(message.thumbnailPath, writer.uint32(42).fork()).join();
    }
    ...
    if (message.audioDevice !== undefined) {
      DigitalAudio_Device.encode(message.audioDevice, writer.uint32(50).fork()).join();
    }
    if (message.videoDevice !== undefined) {
      Media_VideoDevice.encode(message.videoDevice, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): VideoInput {
...
export const VideoInput_SettingsDocument: MessageFns<VideoInput_SettingsDocument> = {
  encode(message: VideoInput_SettingsDocument, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.inputs) {
      VideoInput.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): VideoInput_SettingsDocument {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): VideoInput_SettingsDocument {
    return {
      inputs: globalThis.Array.isArray(object?.inputs) ? object.inputs.map((e: any) => VideoInput.fromJSON(e)) : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<VideoInput_SettingsDocument>, I>>(base?: I): VideoInput_SettingsDocument {
...
export const AudioInput: MessageFns<AudioInput> = {
  encode(message: AudioInput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.behaviorMode !== undefined) {
      AudioInput_BehaviorMode.encode(message.behaviorMode, writer.uint32(42).fork()).join();
    }
    if (message.audioDevice !== undefined) {
      DigitalAudio_Device.encode(message.audioDevice, writer.uint32(26).fork()).join();
    }
    if (message.videoDevice !== undefined) {
      Media_VideoDevice.encode(message.videoDevice, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
export const AudioInput_BehaviorMode: MessageFns<AudioInput_BehaviorMode> = {
  encode(message: AudioInput_BehaviorMode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.on !== undefined) {
      AudioInput_BehaviorMode_On.encode(message.on, writer.uint32(10).fork()).join();
    }
    if (message.off !== undefined) {
      AudioInput_BehaviorMode_Off.encode(message.off, writer.uint32(18).fork()).join();
    }
    if (message.autoOn !== undefined) {
      AudioInput_BehaviorMode_AutoOn.encode(message.autoOn, writer.uint32(26).fork()).join();
    }
    if (message.autoOff !== undefined) {
      AudioInput_BehaviorMode_AutoOff.encode(message.autoOff, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AudioInput_BehaviorMode {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<AudioInput_BehaviorMode>, I>>(base?: I): AudioInput_BehaviorMode {
...
export const AudioInput_BehaviorMode_On: MessageFns<AudioInput_BehaviorMode_On> = {
  encode(_: AudioInput_BehaviorMode_On, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AudioInput_BehaviorMode_On {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<AudioInput_BehaviorMode_On>, I>>(base?: I): AudioInput_BehaviorMode_On {
...
export const AudioInput_BehaviorMode_Off: MessageFns<AudioInput_BehaviorMode_Off> = {
  encode(_: AudioInput_BehaviorMode_Off, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AudioInput_BehaviorMode_Off {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<AudioInput_BehaviorMode_Off>, I>>(base?: I): AudioInput_BehaviorMode_Off {
...
export const AudioInput_BehaviorMode_AutoOff: MessageFns<AudioInput_BehaviorMode_AutoOff> = {
  encode(_: AudioInput_BehaviorMode_AutoOff, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AudioInput_BehaviorMode_AutoOff {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<AudioInput_BehaviorMode_AutoOff>, I>>(base?: I): AudioInput_BehaviorMode_AutoOff {
...
export const AudioInput_BehaviorMode_AutoOn: MessageFns<AudioInput_BehaviorMode_AutoOn> = {
  encode(message: AudioInput_BehaviorMode_AutoOn, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AudioInput_BehaviorMode_AutoOn {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<AudioInput_BehaviorMode_AutoOn>, I>>(base?: I): AudioInput_BehaviorMode_AutoOn {
