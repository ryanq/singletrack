...
import { Layer_Blending, Layer_BlendMode, layer_BlendModeFromJSON, layer_BlendModeToJSON } from "./layers";
...
export function action_ContentDestinationFromJSON(object: any): Action_ContentDestination {
  switch (object) {
    case 0:
...
export function action_ContentDestinationToJSON(object: Action_ContentDestination): string {
  switch (object) {
...
export function action_MediaType_PlaybackBehaviorFromJSON(object: any): Action_MediaType_PlaybackBehavior {
  switch (object) {
    case 0:
...
export function action_MediaType_PlaybackBehaviorToJSON(object: Action_MediaType_PlaybackBehavior): string {
  switch (object) {
...
export function action_MediaType_EndBehaviorFromJSON(object: any): Action_MediaType_EndBehavior {
  switch (object) {
    case 0:
...
export function action_MediaType_EndBehaviorToJSON(object: Action_MediaType_EndBehavior): string {
  switch (object) {
...
export const Action: MessageFns<Action> = {
  encode(message: Action, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.label !== undefined) {
      Action_Label.encode(message.label, writer.uint32(26).fork()).join();
    }
    if (message.delayTime !== 0) {
      writer.uint32(33).double(message.delayTime);
    }
    if (message.oldType !== undefined) {
      Action_OldType.encode(message.oldType, writer.uint32(42).fork()).join();
    }
    if (message.isEnabled !== false) {
      writer.uint32(48).bool(message.isEnabled);
    }
    if (message.layerIdentification !== undefined) {
      Action_LayerIdentification.encode(message.layerIdentification, writer.uint32(58).fork()).join();
    }
    ...
    if (message.collectionElement !== undefined) {
      CollectionElementType.encode(message.collectionElement, writer.uint32(130).fork()).join();
    }
    if (message.playlistItem !== undefined) {
      Action_PlaylistItemType.encode(message.playlistItem, writer.uint32(138).fork()).join();
    }
    if (message.blendMode !== undefined) {
      Action_BlendModeType.encode(message.blendMode, writer.uint32(146).fork()).join();
    }
    if (message.transition !== undefined) {
      Action_TransitionType.encode(message.transition, writer.uint32(154).fork()).join();
    }
    if (message.media !== undefined) {
      Action_MediaType.encode(message.media, writer.uint32(162).fork()).join();
    }
    if (message.doubleItem !== undefined) {
      Action_DoubleType.encode(message.doubleItem, writer.uint32(170).fork()).join();
    }
    if (message.effects !== undefined) {
      Action_EffectsType.encode(message.effects, writer.uint32(178).fork()).join();
    }
    if (message.slide !== undefined) {
      Action_SlideType.encode(message.slide, writer.uint32(186).fork()).join();
    }
    if (message.background !== undefined) {
      Action_BackgroundType.encode(message.background, writer.uint32(194).fork()).join();
    }
    if (message.timer !== undefined) {
      Action_TimerType.encode(message.timer, writer.uint32(202).fork()).join();
    }
    if (message.clear !== undefined) {
      Action_ClearType.encode(message.clear, writer.uint32(210).fork()).join();
    }
    if (message.stage !== undefined) {
      Action_StageLayoutType.encode(message.stage, writer.uint32(218).fork()).join();
    }
    if (message.prop !== undefined) {
      Action_PropType.encode(message.prop, writer.uint32(226).fork()).join();
    }
    if (message.mask !== undefined) {
      Action_MaskType.encode(message.mask, writer.uint32(234).fork()).join();
    }
    if (message.message !== undefined) {
      Action_MessageType.encode(message.message, writer.uint32(242).fork()).join();
    }
    if (message.communication !== undefined) {
      Action_CommunicationType.encode(message.communication, writer.uint32(258).fork()).join();
    }
    if (message.multiScreen !== undefined) {
      Action_MultiScreenType.encode(message.multiScreen, writer.uint32(266).fork()).join();
    }
    if (message.presentationDocument !== undefined) {
      Action_DocumentType.encode(message.presentationDocument, writer.uint32(274).fork()).join();
    }
    if (message.externalPresentation !== undefined) {
      Action_ExternalPresentationType.encode(message.externalPresentation, writer.uint32(290).fork()).join();
    }
    if (message.audienceLook !== undefined) {
      Action_AudienceLookType.encode(message.audienceLook, writer.uint32(298).fork()).join();
    }
    if (message.audioInput !== undefined) {
      Action_AudioInputType.encode(message.audioInput, writer.uint32(306).fork()).join();
    }
    if (message.slideDestination !== undefined) {
      Action_SlideDestinationType.encode(message.slideDestination, writer.uint32(314).fork()).join();
    }
    if (message.macro !== undefined) {
      Action_MacroType.encode(message.macro, writer.uint32(322).fork()).join();
    }
    if (message.clearGroup !== undefined) {
      Action_ClearGroupType.encode(message.clearGroup, writer.uint32(330).fork()).join();
    }
    if (message.transportControl !== undefined) {
      Action_TransportControlType.encode(message.transportControl, writer.uint32(338).fork()).join();
    }
    if (message.capture !== undefined) {
      Action_CaptureType.encode(message.capture, writer.uint32(346).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Action {
    return {
      ...
      transportControl: isSet(object.transportControl)
        ...
        : undefined,
      capture: isSet(object.capture) ? Action_CaptureType.fromJSON(object.capture) : undefined,
    };
  },
  ...
  toJSON(message: Action): unknown {
    ...
    if (message.layerIdentification !== undefined) {
      obj.layerIdentification = Action_LayerIdentification.toJSON(message.layerIdentification);
    }
    if (message.duration !== 0) {
    ...
    if (message.collectionElement !== undefined) {
      obj.collectionElement = CollectionElementType.toJSON(message.collectionElement);
    }
    if (message.playlistItem !== undefined) {
    ...
    if (message.communication !== undefined) {
      obj.communication = Action_CommunicationType.toJSON(message.communication);
    }
    if (message.multiScreen !== undefined) {
      obj.multiScreen = Action_MultiScreenType.toJSON(message.multiScreen);
    }
    if (message.presentationDocument !== undefined) {
      obj.presentationDocument = Action_DocumentType.toJSON(message.presentationDocument);
    }
    if (message.externalPresentation !== undefined) {
      obj.externalPresentation = Action_ExternalPresentationType.toJSON(message.externalPresentation);
    }
    if (message.audienceLook !== undefined) {
    ...
    if (message.slideDestination !== undefined) {
      obj.slideDestination = Action_SlideDestinationType.toJSON(message.slideDestination);
    }
    if (message.macro !== undefined) {
    ...
    if (message.transportControl !== undefined) {
      obj.transportControl = Action_TransportControlType.toJSON(message.transportControl);
    }
    if (message.capture !== undefined) {
...
export const Action_OldType: MessageFns<Action_OldType> = {
  encode(message: Action_OldType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_OldType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Action_OldType {
    return {
      ...
      applicationType: isSet(object.applicationType) ? globalThis.Number(object.applicationType) : 0,
    };
  },
...
export const Action_Label: MessageFns<Action_Label> = {
  encode(message: Action_Label, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.text !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_Label {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_LayerIdentification: MessageFns<Action_LayerIdentification> = {
  encode(message: Action_LayerIdentification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_LayerIdentification {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_PlaylistItemType: MessageFns<Action_PlaylistItemType> = {
  encode(message: Action_PlaylistItemType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.playlistUuid !== undefined) {
      UUID.encode(message.playlistUuid, writer.uint32(10).fork()).join();
    }
    if (message.playlistName !== "") {
      writer.uint32(18).string(message.playlistName);
    }
    if (message.itemUuid !== undefined) {
      UUID.encode(message.itemUuid, writer.uint32(26).fork()).join();
    }
    if (message.itemName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_PlaylistItemType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Action_PlaylistItemType {
    return {
      ...
      selectPlaylist: isSet(object.selectPlaylist) ? globalThis.Boolean(object.selectPlaylist) : false,
      alwaysRetrigger: isSet(object.alwaysRetrigger) ? globalThis.Boolean(object.alwaysRetrigger) : false,
    };
  },
...
export const Action_BlendModeType: MessageFns<Action_BlendModeType> = {
  encode(message: Action_BlendModeType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.blendMode !== 0) {
      writer.uint32(8).int32(message.blendMode);
    }
    if (message.blend !== undefined) {
      Layer_Blending.encode(message.blend, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_BlendModeType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_TransitionType: MessageFns<Action_TransitionType> = {
  encode(message: Action_TransitionType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.transitionName !== "") {
      writer.uint32(10).string(message.transitionName);
    }
    if (message.transition !== undefined) {
      Transition.encode(message.transition, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_TransitionType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Action_TransitionType {
    return {
      transitionName: isSet(object.transitionName) ? globalThis.String(object.transitionName) : "",
...
export const Action_DoubleType: MessageFns<Action_DoubleType> = {
  encode(message: Action_DoubleType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_DoubleType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_EffectsType: MessageFns<Action_EffectsType> = {
  encode(message: Action_EffectsType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.effects) {
      Effect.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_EffectsType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_MediaType: MessageFns<Action_MediaType> = {
  encode(message: Action_MediaType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.selectedEffectPresetUuid !== undefined) {
      UUID.encode(message.selectedEffectPresetUuid, writer.uint32(18).fork()).join();
    }
    if (message.transition !== undefined) {
      Transition.encode(message.transition, writer.uint32(26).fork()).join();
    }
    for (const v of message.effects) {
      Effect.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.element !== undefined) {
      Media.encode(message.element, writer.uint32(42).fork()).join();
    }
    ...
    for (const v of message.markers) {
      Action_MediaType_PlaybackMarker.encode(v!, writer.uint32(98).fork()).join();
    }
    if (message.image !== undefined) {
      Action_MediaType_Image.encode(message.image, writer.uint32(50).fork()).join();
    }
    if (message.video !== undefined) {
      Action_MediaType_Video.encode(message.video, writer.uint32(58).fork()).join();
    }
    if (message.audio !== undefined) {
      Action_MediaType_Audio.encode(message.audio, writer.uint32(66).fork()).join();
    }
    if (message.liveVideo !== undefined) {
      Action_MediaType_LiveVideo.encode(message.liveVideo, writer.uint32(74).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_MediaType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Action_MediaType): unknown {
    ...
    if (message.markers?.length) {
      obj.markers = message.markers.map((e) => Action_MediaType_PlaybackMarker.toJSON(e));
    }
    if (message.image !== undefined) {
...
export const Action_MediaType_Image: MessageFns<Action_MediaType_Image> = {
  encode(_: Action_MediaType_Image, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_MediaType_Image {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_MediaType_Video: MessageFns<Action_MediaType_Video> = {
  encode(message: Action_MediaType_Video, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_MediaType_Video {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Action_MediaType_Video {
    return {
      playbackBehavior: isSet(object.playbackBehavior)
        ...
        : 0,
      endBehavior: isSet(object.endBehavior) ? action_MediaType_EndBehaviorFromJSON(object.endBehavior) : 0,
  ...
  toJSON(message: Action_MediaType_Video): unknown {
    const obj: any = {};
    if (message.playbackBehavior !== 0) {
      obj.playbackBehavior = action_MediaType_PlaybackBehaviorToJSON(message.playbackBehavior);
    }
    if (message.endBehavior !== 0) {
...
export const Action_MediaType_Audio: MessageFns<Action_MediaType_Audio> = {
  encode(message: Action_MediaType_Audio, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.playbackBehavior !== 0) {
      writer.uint32(8).int32(message.playbackBehavior);
    }
    if (message.loopTime !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_MediaType_Audio {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_MediaType_LiveVideo: MessageFns<Action_MediaType_LiveVideo> = {
  encode(_: Action_MediaType_LiveVideo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_MediaType_LiveVideo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_MediaType_PlaybackMarker: MessageFns<Action_MediaType_PlaybackMarker> = {
  encode(message: Action_MediaType_PlaybackMarker, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).join();
    }
    if (message.time !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_MediaType_PlaybackMarker {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_SlideType: MessageFns<Action_SlideType> = {
  encode(message: Action_SlideType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.presentation !== undefined) {
      PresentationSlide.encode(message.presentation, writer.uint32(18).fork()).join();
    }
    if (message.prop !== undefined) {
      PropSlide.encode(message.prop, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_SlideType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_BackgroundType: MessageFns<Action_BackgroundType> = {
  encode(message: Action_BackgroundType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.element !== undefined) {
      Background.encode(message.element, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_BackgroundType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseAction_TimerType(): Action_TimerType {
  return { actionType: 0, timerIdentification: undefined, timerConfiguration: undefined, incrementAmount: 0 };
}

export const Action_TimerType: MessageFns<Action_TimerType> = {
  encode(message: Action_TimerType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.actionType !== 0) {
      writer.uint32(16).int32(message.actionType);
    }
    if (message.timerIdentification !== undefined) {
      CollectionElementType.encode(message.timerIdentification, writer.uint32(34).fork()).join();
    }
    if (message.timerConfiguration !== undefined) {
      Timer_Configuration.encode(message.timerConfiguration, writer.uint32(82).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_TimerType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Action_TimerType): unknown {
    ...
    if (message.timerIdentification !== undefined) {
      obj.timerIdentification = CollectionElementType.toJSON(message.timerIdentification);
    }
    if (message.timerConfiguration !== undefined) {
      obj.timerConfiguration = Timer_Configuration.toJSON(message.timerConfiguration);
    }
    if (message.incrementAmount !== 0) {
...
export const Action_ClearType: MessageFns<Action_ClearType> = {
  encode(message: Action_ClearType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_ClearType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_ClearGroupType: MessageFns<Action_ClearGroupType> = {
  encode(message: Action_ClearGroupType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identification !== undefined) {
      CollectionElementType.encode(message.identification, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_ClearGroupType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_TransportControlType: MessageFns<Action_TransportControlType> = {
  encode(message: Action_TransportControlType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.play !== undefined) {
      Action_TransportControlType_Play.encode(message.play, writer.uint32(10).fork()).join();
    }
    if (message.pause !== undefined) {
      Action_TransportControlType_Pause.encode(message.pause, writer.uint32(18).fork()).join();
    }
    if (message.jumpToTime !== undefined) {
      Action_TransportControlType_JumpToTime.encode(message.jumpToTime, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_TransportControlType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Action_TransportControlType): unknown {
    ...
    if (message.jumpToTime !== undefined) {
      obj.jumpToTime = Action_TransportControlType_JumpToTime.toJSON(message.jumpToTime);
    }
    return obj;
  },
...
export const Action_TransportControlType_Play: MessageFns<Action_TransportControlType_Play> = {
  encode(_: Action_TransportControlType_Play, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_TransportControlType_Play {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_TransportControlType_Pause: MessageFns<Action_TransportControlType_Pause> = {
  encode(_: Action_TransportControlType_Pause, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_TransportControlType_Pause {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_TransportControlType_JumpToTime: MessageFns<Action_TransportControlType_JumpToTime> = {
  encode(message: Action_TransportControlType_JumpToTime, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.time !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_TransportControlType_JumpToTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Action_TransportControlType_JumpToTime>, I>>(
    ...
    return Action_TransportControlType_JumpToTime.fromPartial(base ?? ({} as any));
  },
...
export const Action_StageLayoutType: MessageFns<Action_StageLayoutType> = {
  encode(message: Action_StageLayoutType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.stageScreenAssignments) {
      Stage_ScreenAssignment.encode(v!, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_StageLayoutType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Action_StageLayoutType {
    return {
      stageScreenAssignments: globalThis.Array.isArray(object?.stageScreenAssignments)
  ...
  toJSON(message: Action_StageLayoutType): unknown {
    ...
    if (message.stageScreenAssignments?.length) {
      obj.stageScreenAssignments = message.stageScreenAssignments.map((e) => Stage_ScreenAssignment.toJSON(e));
    }
    if (message.slideTarget !== 0) {
...
export const Action_SlideDestinationType: MessageFns<Action_SlideDestinationType> = {
  encode(message: Action_SlideDestinationType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.slideTarget !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_SlideDestinationType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_PropType: MessageFns<Action_PropType> = {
  encode(message: Action_PropType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identification !== undefined) {
      CollectionElementType.encode(message.identification, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_PropType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_MaskType: MessageFns<Action_MaskType> = {
  encode(message: Action_MaskType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identification !== undefined) {
      CollectionElementType.encode(message.identification, writer.uint32(26).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_MaskType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_MessageType: MessageFns<Action_MessageType> = {
  encode(message: Action_MessageType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.messageIdentificaton !== undefined) {
      CollectionElementType.encode(message.messageIdentificaton, writer.uint32(10).fork()).join();
    }
    for (const v of message.content) {
      Message_TokenValue.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_MessageType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Action_MessageType): unknown {
    const obj: any = {};
    if (message.messageIdentificaton !== undefined) {
      obj.messageIdentificaton = CollectionElementType.toJSON(message.messageIdentificaton);
    }
...
export const Action_CommunicationType: MessageFns<Action_CommunicationType> = {
  encode(message: Action_CommunicationType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.deviceIdentification !== undefined) {
      CollectionElementType.encode(message.deviceIdentification, writer.uint32(10).fork()).join();
    }
    if (message.format !== "") {
    ...
    for (const v of message.commands) {
      Action_CommunicationType_Command.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.midiCommand !== undefined) {
      Action_CommunicationType_MIDICommand.encode(message.midiCommand, writer.uint32(42).fork()).join();
    }
    if (message.globalCacheCommand !== undefined) {
      Action_CommunicationType_GlobalCacheCommand.encode(message.globalCacheCommand, writer.uint32(50).fork()).join();
    }
    if (message.gvg100Command !== undefined) {
      Action_CommunicationType_GVG100Command.encode(message.gvg100Command, writer.uint32(58).fork()).join();
    }
    if (message.sonyBVSCommand !== undefined) {
      Action_CommunicationType_SonyBVSCommand.encode(message.sonyBVSCommand, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_CommunicationType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Action_CommunicationType): unknown {
    const obj: any = {};
    if (message.deviceIdentification !== undefined) {
      obj.deviceIdentification = CollectionElementType.toJSON(message.deviceIdentification);
    }
    if (message.format !== "") {
    ...
    if (message.commands?.length) {
      obj.commands = message.commands.map((e) => Action_CommunicationType_Command.toJSON(e));
    }
    if (message.midiCommand !== undefined) {
      obj.midiCommand = Action_CommunicationType_MIDICommand.toJSON(message.midiCommand);
    }
    if (message.globalCacheCommand !== undefined) {
      obj.globalCacheCommand = Action_CommunicationType_GlobalCacheCommand.toJSON(message.globalCacheCommand);
    }
    if (message.gvg100Command !== undefined) {
      obj.gvg100Command = Action_CommunicationType_GVG100Command.toJSON(message.gvg100Command);
    }
    if (message.sonyBVSCommand !== undefined) {
      obj.sonyBVSCommand = Action_CommunicationType_SonyBVSCommand.toJSON(message.sonyBVSCommand);
    }
    return obj;
  },
...
export const Action_CommunicationType_Command: MessageFns<Action_CommunicationType_Command> = {
  encode(message: Action_CommunicationType_Command, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    if (message.replacementRange !== undefined) {
      IntRange.encode(message.replacementRange, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_CommunicationType_Command {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_CommunicationType_MIDICommand: MessageFns<Action_CommunicationType_MIDICommand> = {
  encode(message: Action_CommunicationType_MIDICommand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_CommunicationType_MIDICommand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Action_CommunicationType_MIDICommand): unknown {
    const obj: any = {};
    if (message.state !== 0) {
      obj.state = action_CommunicationType_MIDICommand_StateToJSON(message.state);
    }
    if (message.channel !== 0) {
  ...
  create<I extends Exact<DeepPartial<Action_CommunicationType_MIDICommand>, I>>(
    ...
    return Action_CommunicationType_MIDICommand.fromPartial(base ?? ({} as any));
  },
...
export const Action_CommunicationType_GlobalCacheCommand: MessageFns<Action_CommunicationType_GlobalCacheCommand> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_CommunicationType_GlobalCacheCommand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Action_CommunicationType_GlobalCacheCommand>, I>>(
    ...
    return Action_CommunicationType_GlobalCacheCommand.fromPartial(base ?? ({} as any));
  },
...
export const Action_CommunicationType_GVG100Command: MessageFns<Action_CommunicationType_GVG100Command> = {
  encode(message: Action_CommunicationType_GVG100Command, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.commandAction !== 0) {
      writer.uint32(8).int32(message.commandAction);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_CommunicationType_GVG100Command {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Action_CommunicationType_GVG100Command>, I>>(
    ...
    return Action_CommunicationType_GVG100Command.fromPartial(base ?? ({} as any));
  },
...
export const Action_CommunicationType_SonyBVSCommand: MessageFns<Action_CommunicationType_SonyBVSCommand> = {
  encode(message: Action_CommunicationType_SonyBVSCommand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.commandAction !== 0) {
      writer.uint32(8).int32(message.commandAction);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_CommunicationType_SonyBVSCommand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Action_CommunicationType_SonyBVSCommand>, I>>(
    ...
    return Action_CommunicationType_SonyBVSCommand.fromPartial(base ?? ({} as any));
  },
...
export const Action_MultiScreenType: MessageFns<Action_MultiScreenType> = {
  encode(message: Action_MultiScreenType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identification !== undefined) {
      CollectionElementType.encode(message.identification, writer.uint32(26).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_MultiScreenType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_DocumentType: MessageFns<Action_DocumentType> = {
  encode(message: Action_DocumentType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identification !== undefined) {
      CollectionElementType.encode(message.identification, writer.uint32(10).fork()).join();
    }
    if (message.selectedArrangement !== undefined) {
      UUID.encode(message.selectedArrangement, writer.uint32(18).fork()).join();
    }
    if (message.contentDestination !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_DocumentType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_ExternalPresentationType: MessageFns<Action_ExternalPresentationType> = {
  encode(message: Action_ExternalPresentationType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_ExternalPresentationType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_AudienceLookType: MessageFns<Action_AudienceLookType> = {
  encode(message: Action_AudienceLookType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identification !== undefined) {
      CollectionElementType.encode(message.identification, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_AudienceLookType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_AudioInputType: MessageFns<Action_AudioInputType> = {
  encode(message: Action_AudioInputType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.index !== 0) {
    ...
    if (message.behaviorMode !== undefined) {
      AudioInput_BehaviorMode.encode(message.behaviorMode, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_AudioInputType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Action_AudioInputType {
    return {
      ...
      overrideMode: isSet(object.overrideMode) ? globalThis.Boolean(object.overrideMode) : false,
      behaviorMode: isSet(object.behaviorMode) ? AudioInput_BehaviorMode.fromJSON(object.behaviorMode) : undefined,
      overrideVolume: isSet(object.overrideVolume) ? globalThis.Boolean(object.overrideVolume) : false,
...
export const Action_MacroType: MessageFns<Action_MacroType> = {
  encode(message: Action_MacroType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identification !== undefined) {
      CollectionElementType.encode(message.identification, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_MacroType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Action_CaptureType: MessageFns<Action_CaptureType> = {
  encode(message: Action_CaptureType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.start !== undefined) {
      Action_CaptureType_CaptureStart.encode(message.start, writer.uint32(10).fork()).join();
    }
    if (message.stop !== undefined) {
      Action_CaptureType_CaptureStop.encode(message.stop, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_CaptureType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.start = Action_CaptureType_CaptureStart.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.stop = Action_CaptureType_CaptureStop.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Action_CaptureType {
    return {
      start: isSet(object.start) ? Action_CaptureType_CaptureStart.fromJSON(object.start) : undefined,
      stop: isSet(object.stop) ? Action_CaptureType_CaptureStop.fromJSON(object.stop) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<Action_CaptureType>, I>>(base?: I): Action_CaptureType {
    return Action_CaptureType.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Action_CaptureType>, I>>(object: I): Action_CaptureType {
    const message = createBaseAction_CaptureType();
...
export const Action_CaptureType_CaptureStart: MessageFns<Action_CaptureType_CaptureStart> = {
  encode(message: Action_CaptureType_CaptureStart, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.presetIdentification !== undefined) {
      CollectionElementType.encode(message.presetIdentification, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Action_CaptureType_CaptureStart {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.presetIdentification = CollectionElementType.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  toJSON(message: Action_CaptureType_CaptureStart): unknown {
    const obj: any = {};
    if (message.presetIdentification !== undefined) {
      obj.presetIdentification = CollectionElementType.toJSON(message.presetIdentification);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Action_CaptureType_CaptureStart>, I>>(base?: I): Action_CaptureType_CaptureStart {
  ...
  fromPartial<I extends Exact<DeepPartial<Action_CaptureType_CaptureStart>, I>>(
    ...
    const message = createBaseAction_CaptureType_CaptureStart();
    message.presetIdentification = (object.presetIdentification !== undefined && object.presetIdentification !== null)
...
export const Action_CaptureType_CaptureStop: MessageFns<Action_CaptureType_CaptureStop> = {
  encode(message: Action_CaptureType_CaptureStop, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Action_CaptureType_CaptureStop {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Action_CaptureType_CaptureStop>, I>>(base?: I): Action_CaptureType_CaptureStop {
