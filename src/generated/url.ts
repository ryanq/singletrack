...
export const URL: MessageFns<URL> = {
  encode(message: URL, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.local !== undefined) {
      URL_LocalRelativePath.encode(message.local, writer.uint32(34).fork()).join();
    }
    if (message.external !== undefined) {
      URL_ExternalRelativePath.encode(message.external, writer.uint32(42).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): URL {
    return {
      ...
      absoluteString: isSet(object.absoluteString) ? globalThis.String(object.absoluteString) : undefined,
...
export const URL_LocalRelativePath: MessageFns<URL_LocalRelativePath> = {
  encode(message: URL_LocalRelativePath, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.root !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): URL_LocalRelativePath {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const URL_ExternalRelativePath: MessageFns<URL_ExternalRelativePath> = {
  encode(message: URL_ExternalRelativePath, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.macos !== undefined) {
      URL_ExternalRelativePath_MacOSExternalVolume.encode(message.macos, writer.uint32(10).fork()).join();
    }
    if (message.win32 !== undefined) {
      URL_ExternalRelativePath_Win32ExternalVolume.encode(message.win32, writer.uint32(18).fork()).join();
    }
    if (message.path !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): URL_ExternalRelativePath {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: URL_ExternalRelativePath): unknown {
    const obj: any = {};
    if (message.macos !== undefined) {
      obj.macos = URL_ExternalRelativePath_MacOSExternalVolume.toJSON(message.macos);
    }
    if (message.win32 !== undefined) {
      obj.win32 = URL_ExternalRelativePath_Win32ExternalVolume.toJSON(message.win32);
    }
    if (message.path !== "") {
      obj.path = message.path;
    }
...
export const URL_ExternalRelativePath_MacOSExternalVolume: MessageFns<URL_ExternalRelativePath_MacOSExternalVolume> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): URL_ExternalRelativePath_MacOSExternalVolume {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): URL_ExternalRelativePath_MacOSExternalVolume {
    return { volumeName: isSet(object.volumeName) ? globalThis.String(object.volumeName) : "" };
  },
  ...
  create<I extends Exact<DeepPartial<URL_ExternalRelativePath_MacOSExternalVolume>, I>>(
    ...
    return URL_ExternalRelativePath_MacOSExternalVolume.fromPartial(base ?? ({} as any));
  },
...
export const URL_ExternalRelativePath_Win32ExternalVolume: MessageFns<URL_ExternalRelativePath_Win32ExternalVolume> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): URL_ExternalRelativePath_Win32ExternalVolume {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): URL_ExternalRelativePath_Win32ExternalVolume {
    return {
      driveLetter: isSet(object.driveLetter) ? globalThis.String(object.driveLetter) : "",
      volumeName: isSet(object.volumeName) ? globalThis.String(object.volumeName) : "",
      networkShare: isSet(object.networkShare) ? globalThis.Boolean(object.networkShare) : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<URL_ExternalRelativePath_Win32ExternalVolume>, I>>(
    ...
    return URL_ExternalRelativePath_Win32ExternalVolume.fromPartial(base ?? ({} as any));
  },
...
export const URLs: MessageFns<URLs> = {
  encode(message: URLs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.urls) {
      URL.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): URLs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): URLs {
    return { urls: globalThis.Array.isArray(object?.urls) ? object.urls.map((e: any) => URL.fromJSON(e)) : [] };
  },
