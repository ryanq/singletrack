...
export const Cue: MessageFns<Cue> = {
  encode(message: Cue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.completionTargetUuid !== undefined) {
      UUID.encode(message.completionTargetUuid, writer.uint32(34).fork()).join();
    }
    ...
    if (message.completionActionUuid !== undefined) {
      UUID.encode(message.completionActionUuid, writer.uint32(50).fork()).join();
    }
    if (message.triggerTime !== undefined) {
      Cue_TimecodeTime.encode(message.triggerTime, writer.uint32(58).fork()).join();
    }
    if (message.hotKey !== undefined) {
      HotKey.encode(message.hotKey, writer.uint32(66).fork()).join();
    }
    for (const v of message.actions) {
      Action.encode(v!, writer.uint32(82).fork()).join();
    }
    for (const v of message.pendingImports) {
      Cue_PendingImportsEntry.encode(v!, writer.uint32(90).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Cue {
  ...
  toJSON(message: Cue): unknown {
    ...
    if (message.pendingImports?.length) {
      obj.pendingImports = message.pendingImports.map((e) => Cue_PendingImportsEntry.toJSON(e));
    }
    if (message.isEnabled !== false) {
...
export const Cue_TimecodeTime: MessageFns<Cue_TimecodeTime> = {
  encode(message: Cue_TimecodeTime, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.time !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Cue_TimecodeTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Cue_TimecodeTime>, I>>(base?: I): Cue_TimecodeTime {
...
export const Cue_PendingImportsEntry: MessageFns<Cue_PendingImportsEntry> = {
  encode(message: Cue_PendingImportsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      URLs.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Cue_PendingImportsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Cue_PendingImportsEntry>, I>>(base?: I): Cue_PendingImportsEntry {
